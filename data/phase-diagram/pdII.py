...
line_FRG2p1,=ax1.plot(pb_Nf2p1[:,0],Tc_Nf2p1,'k--',dashes=(5,2),linewidth=1.5,markersize=5,zorder=50,label=r'FRG $N_f=2+1$')
...
ax1.text(230, 165, r'$\frac{\mu_B}{T}=2$',fontsize=10, color='k')
ax1.text(530, 165, r'$\frac{\mu_B}{T}=3$',fontsize=10, color='k')
...
ax1.legend((line_FRG2p1,band_inhom,band_WB,band_HotQCD,line_Fischer,line_Gao,points_star,points_alba,points_andronic,points_becattini,points_vovchenko,points_Sagun),(r'FRG: $N_f=2+1$',r'FRG: inhom',r'Lattice: WB',r'Lattice: HotQCD',r'DSE: Fischer et al.',r'DSE: Gao et al.',r'freezeout: STAR',r'freezeout: Alba et al.',r'freezeout: Andronic et al.',r'freezeout: Becattini et al.',r'freezeout: Vovchenko et al.',r'freezeout: Sagun et al.'),loc=3,ncol=1,fontsize='xx-small',frameon=True,shadow=True,handlelength=3.,borderpad=0.3,borderaxespad=0.5,numpoints=1,mode=None,framealpha=1.,labelspacing=0.37)
...
fig.savefig("phasediagramII.pdf")
