...
for t in range(0,20):
    if t<10:
       r42100[:,t]=spline(T/ct[t],r42mub100cen,xsame)
    else:
       r42100[:,t]=spline(T/ct[t-10],r42mub100cen,xsame)
...
for t in range(0,20):
    if t<10:
       r42160[:,t]=spline(T/ct[t],r42mub160cen,xsame)
    else:
       r42160[:,t]=spline(T/ct[t-10],r42mub160cen,xsame)
...
for t in range(0,20):
    if t<10:
       r62100[:,t]=spline(T/ct[t],r62mub100cen,xsame)
    else:
       r62100[:,t]=spline(T/ct[t-10],r62mub100cen,xsame)
...
for t in range(0,20):
    if t<10:
       r62160[:,t]=spline(T/ct[t],r62mub160cen,xsame)
    else:
       r62160[:,t]=spline(T/ct[t-10],r62mub160cen,xsame)
...
for t in range(0,20):
    if t<10:
       r82100[:,t]=spline(T/ct[t],r82mub100cen,xsame)
    else:
       r82100[:,t]=spline(T/ct[t-10],r82mub100cen,xsame)
...
for t in range(0,20):
    if t<10:
       r82160[:,t]=spline(T/ct[t],r82mub160cen,xsame)
    else:
       r82160[:,t]=spline(T/ct[t-10],r82mub160cen,xsame)
