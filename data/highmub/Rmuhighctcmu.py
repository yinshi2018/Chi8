...
r42400=np.zeros((300,20))
r62400=np.zeros((300,20))
r82400=np.zeros((300,20))
#########################################################################################
...
for t in range(0,20):
    if t<10:
       ...
       r42400[:,t]=spline(T/ct[t-10],r42mub400down,xsame)
...
#ax1.legend([(band_mub0,line_mub0),(band_mub100,line_mub100),(band_mub400,line_mub400)],[r'$\mu_B=0$ MeV',r'$\mu_B=100$ MeV',r'$\mu_B=400$ MeV'],loc=0,fontsize='x-small',frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
