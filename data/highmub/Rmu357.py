...
# Data for plotting
chi1mub20=np.loadtxt(r'./mub20/final/buffer/chi1.dat')
chi3mub20=np.loadtxt(r'./mub20/final/buffer/chi3.dat')
chi5mub20=np.loadtxt(r'./mub20/final/buffer/chi5.dat')
chi7mub20=np.loadtxt(r'./mub20/final/buffer/chi7.dat')
...
r71mub20=np.loadtxt(r'./mub20/final/buffer/R71.dat')
r42mub20=chi4mub20/chi2mub20
r62mub20=chi6mub20/chi2mub20
r82mub20=chi8mub20/chi2mub20
chi1mub40=np.loadtxt(r'./mub40/final/buffer/chi1.dat')
chi3mub40=np.loadtxt(r'./mub40/final/buffer/chi3.dat')
chi5mub40=np.loadtxt(r'./mub40/final/buffer/chi5.dat')
chi7mub40=np.loadtxt(r'./mub40/final/buffer/chi7.dat')
r31mub40=chi3mub40/chi1mub40
r51mub40=chi5mub40/chi1mub40
r71mub40=np.loadtxt(r'./mub40/final/buffer/R71.dat')
chi1mub60=np.loadtxt(r'./mub60/final/buffer/chi1.dat')
chi3mub60=np.loadtxt(r'./mub60/final/buffer/chi3.dat')
chi5mub60=np.loadtxt(r'./mub60/final/buffer/chi5.dat')
chi7mub60=np.loadtxt(r'./mub60/final/buffer/chi7.dat')
r31mub60=chi3mub60/chi1mub60
r51mub60=chi5mub60/chi1mub60
r71mub60=np.loadtxt(r'./mub60/final/buffer/R71.dat')
chi1mub80=np.loadtxt(r'./mub80/final/buffer/chi1.dat')
chi3mub80=np.loadtxt(r'./mub80/final/buffer/chi3.dat')
chi5mub80=np.loadtxt(r'./mub80/final/buffer/chi5.dat')
chi7mub80=np.loadtxt(r'./mub80/final/buffer/chi7.dat')
r31mub80=chi3mub80/chi1mub80
r51mub80=chi5mub80/chi1mub80
r71mub80=np.loadtxt(r'./mub80/final/buffer/R71.dat')
chi1mub100=np.loadtxt(r'./mub100/final/buffer/chi1.dat')
chi3mub100=np.loadtxt(r'./mub100/final/buffer/chi3.dat')
chi5mub100=np.loadtxt(r'./mub100/final/buffer/chi5.dat')
chi7mub100=np.loadtxt(r'./mub100/final/buffer/chi7.dat')
r31mub100=chi3mub100/chi1mub100
r51mub100=chi5mub100/chi1mub100
r71mub100=np.loadtxt(r'./mub100/final/buffer/R71.dat')
chi1mub120=np.loadtxt(r'./mub120/final/buffer/chi1.dat')
chi3mub120=np.loadtxt(r'./mub120/final/buffer/chi3.dat')
chi5mub120=np.loadtxt(r'./mub120/final/buffer/chi5.dat')
chi7mub120=np.loadtxt(r'./mub120/final/buffer/chi7.dat')
r31mub120=chi3mub120/chi1mub120
r51mub120=chi5mub120/chi1mub120
r71mub120=np.loadtxt(r'./mub120/final/buffer/R71.dat')
