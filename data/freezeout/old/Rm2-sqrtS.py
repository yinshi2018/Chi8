...
exp=ax2.errorbar(energyrhic,value62,yerr=erro62,color='b',marker='*',linestyle='',linewidth=1,markersize=10,fillstyle='full',alpha=0.5,zorder=3)
ax2.legend(((point62cen1,band62cen1,line62cen1),(point62cen2,band62cen2,line62cen2),exp),(r'fRG freezeout: I',r'fRG freezeout: II',r'STAR preliminary'),loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
#ax3.errorbar(energy,kurtosis[:,0],color='red')
ax3.plot(blackline,r42line,dashes=[4,2],color='m',linewidth='1')
ax3.legend([(errbartf421,bandtf421,linetf421),(errbartf422,bandtf422,linetf422),exp],[r'fRG freezeout: I',r'fRG freezeout: II',r'STAR data'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
#ax4.plot(energy,r82hcen,color='b',alpha=0.3,zorder=1)
ax4.plot(blackline,r62line,dashes=[4,2],color='m',linewidth='1')
ax4.legend([(errbartf821,bandtf821,linetf821),(errbartf822,bandtf822,linetf822)],[r'fRG freezeout: I',r'fRG freezeout: II'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
ax4.set_xscale('symlog')
ax4.set_yscale('symlog')
#plt.axis([5,230,-10000.,1000.])
