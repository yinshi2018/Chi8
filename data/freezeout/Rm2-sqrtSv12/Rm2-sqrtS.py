...
r32120=np.zeros((300,20))
r42120=np.zeros((300,20))
r62120=np.zeros((300,20))
r82120=np.zeros((300,20))
for t in range(0,20):
    if t<10:
...
min120cen_index=160#int(round(fit7[3,2]))
min120up_index=160#int(round(fit7[3,1]))
min120down_index=160#int(round(fit7[3,0]))
...
r32135=np.zeros((300,20))
r42135=np.zeros((300,20))
r62135=np.zeros((300,20))
r82135=np.zeros((300,20))
for t in range(0,20):
    if t<10:
...
min135cen_index=160#int(round(fit7[3,2]))
min135up_index=160#int(round(fit7[3,1]))
min135down_index=160#int(round(fit7[3,0]))
...
min148cen_index=159#int(round(fit7[4,2]))
min148up_index=159#int(round(fit7[4,1]))
min148down_index=159#int(round(fit7[4,0]))
...
r32165=np.zeros((300,100))
r42165=np.zeros((300,100))
r62165=np.zeros((300,100))
r82165=np.zeros((300,100))
...
r32mub165cen=spline(T/ctcen,r32mub165cen,xsame)*c
max165=max165*c
min165=min165*c
...
min165cen_index=159#int(round(fit7[5,2]))
min165up_index=159#int(round(fit7[5,1]))
min165down_index=159#int(round(fit7[5,0]))
...
r32180=np.zeros((300,100))
r42180=np.zeros((300,100))
r62180=np.zeros((300,100))
r82180=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub180cen=spline(T/ctcen,r32mub180cen,xsame)*c
max180=max180*c
min180=min180*c
...
min180cen_index=158#int(round(fit7[5,2]))
min180up_index=158#int(round(fit7[5,1]))
min180down_index=158#int(round(fit7[5,0]))
...
min196cen_index=157#int(round(fit7[5,2]))
min196up_index=157#int(round(fit7[5,1]))
min196down_index=157#int(round(fit7[5,0]))
...
r32215=np.zeros((300,100))
r42215=np.zeros((300,100))
r62215=np.zeros((300,100))
r82215=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub215cen=spline(T/ctcen,r32mub215cen,xsame)*c
max215=max215*c
min215=min215*c
...
min215cen_index=156#int(round(fit7[5,2]))
min215up_index=156#int(round(fit7[5,1]))
min215down_index=156#int(round(fit7[5,0]))
...
r32230=np.zeros((300,100))
r42230=np.zeros((300,100))
r62230=np.zeros((300,100))
r82230=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub230cen=spline(T/ctcen,r32mub230cen,xsame)*c
max230=max230*c
min230=min230*c
...
min230cen_index=156#int(round(fit7[5,2]))
min230up_index=156#int(round(fit7[5,1]))
min230down_index=156#int(round(fit7[5,0]))
...
min252cen_index=154#int(round(fit7[6,2]))
min252up_index=154#int(round(fit7[6,1]))
min252down_index=154#int(round(fit7[6,0]))
...
r32265=np.zeros((300,100))
r42265=np.zeros((300,100))
r62265=np.zeros((300,100))
r82265=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub265cen=spline(T/ctcen,r32mub265cen,xsame)*c
max265=max265*c
min265=min265*c
...
min265cen_index=153#int(round(fit7[5,2]))
min265up_index=153#int(round(fit7[5,1]))
min265down_index=153#int(round(fit7[5,0]))
...
r32280=np.zeros((300,100))
r42280=np.zeros((300,100))
r62280=np.zeros((300,100))
r82280=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub280cen=spline(T/ctcen,r32mub280cen,xsame)*c
max280=max280*c
min280=min280*c
...
min280cen_index=152#int(round(fit7[5,2]))
min280up_index=152#int(round(fit7[5,1]))
min280down_index=152#int(round(fit7[5,0]))
...
min303cen_index=150#int(round(fit7[7,2]))
min303up_index=150#int(round(fit7[7,1]))
min303down_index=150#int(round(fit7[7,0]))
...
r32310=np.zeros((300,100))
r42310=np.zeros((300,100))
r62310=np.zeros((300,100))
r82310=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub310cen=spline(T/ctcen,r32mub310cen,xsame)*c
max310=max310*c
min310=min310*c
...
min310cen_index=149#int(round(fit7[5,2]))
min310up_index=149#int(round(fit7[5,1]))
min310down_index=149#int(round(fit7[5,0]))
...
r32320=np.zeros((300,100))
r42320=np.zeros((300,100))
r62320=np.zeros((300,100))
r82320=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub320cen=spline(T/ctcen,r32mub320cen,xsame)*c
max320=max320*c
min320=min320*c
...
min320cen_index=148#int(round(fit7[5,2]))
min320up_index=148#int(round(fit7[5,1]))
min320down_index=148#int(round(fit7[5,0]))
...
r32330=np.zeros((300,100))
r42330=np.zeros((300,100))
r62330=np.zeros((300,100))
r82330=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub330cen=spline(T/ctcen,r32mub330cen,xsame)*c
max330=max330*c
min330=min330*c
...
min330cen_index=147#int(round(fit7[5,2]))
min330up_index=147#int(round(fit7[5,1]))
min330down_index=147#int(round(fit7[5,0]))
...
r32340=np.zeros((300,100))
r42340=np.zeros((300,100))
r62340=np.zeros((300,100))
r82340=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub340cen=spline(T/ctcen,r32mub340cen,xsame)*c
max340=max340*c
min340=min340*c
...
min340cen_index=146#int(round(fit7[5,2]))
min340up_index=146#int(round(fit7[5,1]))
min340down_index=146#int(round(fit7[5,0]))
...
r32350=np.zeros((300,100))
r42350=np.zeros((300,100))
r62350=np.zeros((300,100))
r82350=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub350cen=spline(T/ctcen,r32mub350cen,xsame)*c
max350=max350*c
min350=min350*c
...
min350cen_index=144#int(round(fit7[5,2]))
min350up_index=144#int(round(fit7[5,1]))
min350down_index=144#int(round(fit7[5,0]))
...
r32360=np.zeros((300,100))
r42360=np.zeros((300,100))
r62360=np.zeros((300,100))
r82360=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub360cen=spline(T/ctcen,r32mub360cen,xsame)*c
max360=max360*c
min360=min360*c
...
min360cen_index=143#int(round(fit7[5,2]))
min360up_index=143#int(round(fit7[5,1]))
min360down_index=143#int(round(fit7[5,0]))
...
r32370=np.zeros((300,100))
r42370=np.zeros((300,100))
r62370=np.zeros((300,100))
r82370=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub370cen=spline(T/ctcen,r32mub370cen,xsame)*c
max370=max370*c
min370=min370*c
...
min370cen_index=142#int(round(fit7[5,2]))
min370up_index=142#int(round(fit7[5,1]))
min370down_index=142#int(round(fit7[5,0]))
...
r32380=np.zeros((300,100))
r42380=np.zeros((300,100))
r62380=np.zeros((300,100))
r82380=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub380cen=spline(T/ctcen,r32mub380cen,xsame)*c
max380=max380*c
min380=min380*c
...
min380cen_index=140#int(round(fit7[5,2]))
min380up_index=140#int(round(fit7[5,1]))
min380down_index=140#int(round(fit7[5,0]))
...
r32390=np.zeros((300,100))
r42390=np.zeros((300,100))
r62390=np.zeros((300,100))
r82390=np.zeros((300,100))
for t in range(0,100):
    if t<10:
...
r32mub390cen=spline(T/ctcen,r32mub390cen,xsame)*c
max390=max390*c
min390=min390*c
...
min390cen_index=139#int(round(fit7[5,2]))
min390up_index=139#int(round(fit7[5,1]))
min390down_index=139#int(round(fit7[5,0]))
...
min406cen_index=136#int(round(fit7[8,2]))
min406up_index=136#int(round(fit7[8,1]))
min406down_index=136#int(round(fit7[8,0]))
...
r42cen=[r4222cen,r4268cen,r4278cen,r42106cen,r42120cen,r42135cen,r42148cen,r42165cen,r42180cen,r42196cen,r42215cen,r42230cen,r42252cen,r42265cen,r42280cen,r42303cen,r42310cen,r42320cen,r42330cen,r42340cen,r42350cen,r42360cen,r42370cen,r42380cen,r42390cen,r42406cen]
