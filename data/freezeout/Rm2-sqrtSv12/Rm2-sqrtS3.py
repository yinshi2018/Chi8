...
for num in range(1,20):
    if num==1:
       max5222=np.maximum(r5222[:,num-1],r5222[:,num])
       min5222=np.minimum(r5222[:,num-1],r5222[:,num])
    else:
       max5222=np.maximum(max5222,r5222[:,num])
       min5222=np.minimum(min5222,r5222[:,num])

for t in range(0,20):
    if t<10:
       r5222[:,t]=spline(T/ct[t],r52mub22up,xsame)
    else:
       r5222[:,t]=spline(T/ct[t-10],r52mub22down,xsame)
...
r52mub22cen=spline(T/ctcen,r52mub22cen,xsame)
...
r5222cen=r52mub22cen[min22cen_index]
...
r52=[max5222[min22up_index],max5222[min22down_index],min5222[min22up_index],min5222[min22down_index]]
r52h=[max5222[Tcup[0]],max5222[Tcdown[0]],min5222[Tcup[0]],min5222[Tcdown[0]]]
r5222up=np.max(r52)
r5222down=np.min(r52)
r5222uph=np.max(r52h)
r5222downh=np.min(r52h)
...
r52mub68cen=spline(T/ctcen,r52mub68cen,xsame)
...
r5268cen=r52mub68cen[min68cen_index]
...
r52=[max5268[min68up_index],max5268[min68down_index],min5268[min68up_index],min5268[min68down_index]]
#r42h=[max4268[min68up_index+int(min68up_index*deltat)],max4268[min68down_index+int(min68down_index*deltat)],min4268[min68up_index+int(min68up_index*deltat)],min4268[min68down_index+int(min68down_index*deltat)]]
r52h=[max5268[Tcup[1]],max5268[Tcdown[1]],min5268[Tcup[1]],min5268[Tcdown[1]]]
r5268up=np.max(r52)
r5268down=np.min(r52)
r5268uph=np.max(r52h)
r5268downh=np.min(r52h)
...
r5278cen=r52mub78cen[min78cen_index]
...
r52=[max5278[min78up_index],max5278[min78down_index],min5278[min78up_index],min5278[min78down_index]]
#r42h=[max4278[min78up_index+int(min78up_index*deltat)],max4278[min78down_index+int(min78down_index*deltat)],min4278[min78up_index+int(min78up_index*deltat)],min4278[min78down_index+int(min78down_index*deltat)]]
r52h=[max5278[Tcup[2]],max5278[Tcdown[2]],min5278[Tcup[2]],min5278[Tcdown[2]]]
r5278up=np.max(r52)
r5278down=np.min(r52)
r5278uph=np.max(r52h)
r5278downh=np.min(r52h)
...
r52106cen=r52mub106cen[min106cen_index]
...
r52106hcen=r52mub106cen[Tcen[3]]
...
r52=[max52106[min106up_index],max52106[min106down_index],min52106[min106up_index],min52106[min106down_index]]
#r42h=[max42106[min106up_index+int(min106up_index*deltat)],max42106[min106down_index+int(min106down_index*deltat)],min42106[min106up_index+int(min106up_index*deltat)],min42106[min106down_index+int(min106down_index*deltat)]]
r52h=[max52106[Tcup[3]],max52106[Tcdown[3]],min52106[Tcup[3]],min52106[Tcdown[3]]]
r52106up=np.max(r52)
r52106down=np.min(r52)
r52106uph=np.max(r52h)
r52106downh=np.min(r52h)
...
r52148cen=r52mub148cen[min148cen_index]
...
r52148hcen=r52mub148cen[Tcen[4]]
...
r52=[max52148[min148up_index],max52148[min148down_index],min52148[min148up_index],min52148[min148down_index]]
#r42h=[max42148[min148up_index+int(min148up_index*deltat)],max42148[min148down_index+int(min148down_index*deltat)],min42148[min148up_index+int(min148up_index*deltat)],min42148[min148down_index+int(min148down_index*deltat)]]
r52h=[max52148[Tcup[4]],max52148[Tcdown[4]],min52148[Tcup[4]],min52148[Tcdown[4]]]
r52148up=np.max(r52)
r52148down=np.min(r52)
r52148uph=np.max(r52h)
r52148downh=np.min(r52h)
...
r52196cen=r52mub196cen[min196cen_index]
...
r52196hcen=r52mub196cen[Tcen[5]]
...
r52=[max52196[min196up_index],max52196[min196down_index],min52196[min196up_index],min52196[min196down_index]]
#r42h=[max42196[min196up_index+int(min196up_index*deltat)],max42196[min196down_index+int(min196down_index*deltat)],min42196[min196up_index+int(min196up_index*deltat)],min42196[min196down_index+int(min196down_index*deltat)]]
r52h=[max52196[Tcup[5]],max52196[Tcdown[5]],min52196[Tcup[5]],min52196[Tcdown[5]]]
r52196up=np.max(r52)
r52196down=np.min(r52)
r52196uph=np.max(r52h)
r52196downh=np.min(r52h)
...
r52252cen=r52mub252cen[min252cen_index]
...
r52252hcen=r52mub252cen[Tcen[6]]
...
r52=[max52252[min252up_index],max52252[min252down_index],min52252[min252up_index],min52252[min252down_index]]
#r42h=[max42252[min252up_index+int(min252up_index*deltat)],max42252[min252down_index+int(min252down_index*deltat)],min42252[min252up_index+int(min252up_index*deltat)],min42252[min252down_index+int(min252down_index*deltat)]]
r52h=[max52252[Tcup[6]],max52252[Tcdown[6]],min52252[Tcup[6]],min52252[Tcdown[6]]]
r52252up=np.max(r52)
r52252down=np.min(r52)
r52252uph=np.max(r52h)
r52252downh=np.min(r52h)
...
r52303cen=r52mub303cen[min303cen_index]
...
r52303hcen=r52mub303cen[Tcen[7]]
...
r52=[max52303[min303up_index],max52303[min303down_index],min52303[min303up_index],min52303[min303down_index]]
#r52h=[max42303[min303up_index+int(min303up_index*deltat)],max42303[min303down_index+int(min303down_index*deltat)],min42303[min303up_index+int(min303up_index*deltat)],min42303[min303down_index+int(min303down_index*deltat)]]
r52h=[max52303[Tcup[7]],max52303[Tcdown[7]],min52303[Tcup[7]],min52303[Tcdown[7]]]
r52303up=np.max(r52)
r52303down=np.min(r52)
r52303uph=np.max(r52h)
r52303downh=np.min(r52h)
...
r52406cen=r52mub406cen[min406cen_index]
...
r52406hcen=r52mub406cen[Tcen[8]]
...
r52=[max52406[min406up_index],max52406[min406down_index],min52406[min406up_index],min52406[min406down_index]]
#r52h=[max42406[min406up_index+int(min406up_index*deltat)],max42406[min406down_index+int(min406down_index*deltat)],min42406[min406up_index+int(min406up_index*deltat)],min42406[min406down_index+int(min406down_index*deltat)]]
r52h=[max52406[Tcup[8]],max52406[Tcdown[8]],min52406[Tcup[8]],min52406[Tcdown[8]]]
r52406up=np.max(r52)
r52406down=np.min(r52)
r52406uph=np.max(r52h)
r52406downh=np.min(r52h)
...
r52up=[r5222up,r5268up,r5278up,r52106up,r52148up,r52196up,r52252up,r52303up,r52406up]
r52down=[r5222down,r5268down,r5278down,r52106down,r52148down,r52196down,r52252down,r52303down,r52406down]
r52cen=[r5222cen,r5268cen,r5278cen,r52106cen,r52148cen,r52196cen,r52252cen,r52303cen,r52406cen]
...
for i in range(0,9):
    ...
    r52errup[i]=r52up[i]-r52cen[i]
    r52errdown[i]=r52cen[i]-r52down[i]
...
band62cen3=ax2.fill_between(energy,r62down,r62up,color='r',alpha=0.2,facecolor='r',edgecolor='',zorder=2)
...
bandtf423=ax3.fill_between(energy,r42down,r42up,color='r',alpha=0.2,facecolor='r',edgecolor='',zorder=2)
...
#ax4.errorbar(energy,r82cen,yerr=[r82errup,r82errdown],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,capsize=1,elinewidth=4,zorder=2)
...
bandtf823=ax4.fill_between(energy,r82down,r82up,color='r',alpha=0.2,facecolor='r',edgecolor='',zorder=2)
...
ax3=fig.add_subplot(311)
errbartf421=ax3.errorbar(energy,r52cen,yerr=[r52errdown,r52errup],color='g',marker='^',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,capsize=1,elinewidth=3,zorder=2)
linetf421,=ax3.plot(energy,r52cen,color='g',alpha=0.3,zorder=2)
exp=ax3.errorbar(energy,kurtosis[:,0],yerr=kurtosis[:,1],color='c',marker='*',linestyle='',linewidth=1,markersize=10,fillstyle='full',alpha=0.5,zorder=3)
ax3.plot(blackline,r42line,dashes=[4,2],color='m',linewidth='1')
ax3.set_xscale('symlog')
plt.axis([5,230,-0.5,2.8])
...
ax3.xaxis.set_label_position('top') 
#ax3.set_xlabel('$\sqrt{S_{NN}}$', fontsize=14, color='black')
ax3.set_ylabel(r'$R^B_{52}(R^p_{42})$', fontsize=14, color='black')
#for label in ax1.xaxis.get_ticklabels():
#    label.set_fontsize(10)
for label in ax3.yaxis.get_ticklabels():
    label.set_fontsize(7)
...
linetf821,=ax4.plot(energy,r82cen,color='g',alpha=0.3,zorder=2)
#ax4.fill_between(energy,r82hdown,r82hup,color='b',alpha=0.25,facecolor='b',edgecolor='',zorder=1)
#ax4.plot(energy,r82hcen,color='b',alpha=0.3,zorder=1)
ax4.plot(blackline,r62line,dashes=[4,2],color='m',linewidth='1')
#ax4.legend([(errbartf,bandtf,linetf)],[r'fRG'],loc=0,fontsize='x-small',frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
point62cen2=ax2.errorbar(energy,r62cen,yerr=[r62errdown,r62errup],color='k',marker='s',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.3,capsize=1,elinewidth=5,zorder=2)
...
ax2.legend(((point62cen2,band62cen2,line62cen2),(point62cen3,band62cen3,line62cen3),(point62cen1,line62cen1),exp),(r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR I',r'fRG-LEFT freezeout: STAR II',r'STAR preliminary'),loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
errbartf422=ax3.errorbar(energy,r42cen,yerr=[r42errdown,r42errup],color='k',marker='s',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.3,capsize=1,elinewidth=5,zorder=2)
...
#ax3.errorbar(energy,kurtosis[:,0],color='red')
ax3.plot(blackline,r42line,dashes=[4,2],color='m',linewidth='1')
ax3.legend([(errbartf422,bandtf422,linetf422),(errbartf423,bandtf423,linetf423),(errbartf421,linetf421),exp],[r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR I',r'fRG-LEFT freezeout: STAR II',r'STAR data'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
errbartf822=ax4.errorbar(energy,r82cen,yerr=[r82errdown,r82errup],color='k',marker='s',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.3,capsize=1,elinewidth=5,zorder=2)
...
ax4.plot(blackline,r62line,dashes=[4,2],color='m',linewidth='1')
ax4.legend([(errbartf822,bandtf822,linetf822),(errbartf823,bandtf823,linetf823),(errbartf821,linetf821)],[r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR I',r'fRG-LEFT freezeout: STAR II'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
ax4.set_xscale('symlog')
ax4.set_yscale('symlog')
#plt.axis([5,230,-10000.,1000.])
