...
point62cen3=ax2.errorbar(energy,r62cen,yerr=[r62errdown,r62errup],color='g',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,capsize=3,elinewidth=2,zorder=2)
...
#band62cen3=ax2.fill_between(energy,r62down,r62up,color='g',alpha=0.25,facecolor='g',edgecolor='',zorder=2)
...
errbartf423=ax3.errorbar(energy,r42cen,yerr=[r42errdown,r42errup],color='g',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,capsize=3,elinewidth=2,zorder=2)
...
#bandtf423=ax3.fill_between(energy,r42down,r42up,color='g',alpha=0.25,facecolor='g',edgecolor='',zorder=2)
linetf423,=ax3.plot(energy,r42cen,color='g',alpha=0.3,zorder=2)
...
errbartf823=ax4.errorbar(energy,r82cen,yerr=[r82errdown,r82errup],color='g',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
ax4.errorbar(energy,r82cen,yerr=[r82errup,r82errdown],color='g',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,capsize=3,elinewidth=2,zorder=2)
...
#bandtf823=ax4.fill_between(energy,r82down,r82up,color='g',alpha=0.25,facecolor='g',edgecolor='',zorder=2)
...
#fig=plt.figure()
ax2=fig.add_subplot(312)
point62cen1=ax2.errorbar(energy,r62cen,yerr=[r62errdown,r62errup],color='m',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
#point62h=ax2.errorbar(energy,r62hcen,yerr=[r62errhdown,r62errhup],color='b',marker='^',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=1)
#band62cen1=ax2.fill_between(energy,r62down,r62up,color='m',alpha=0.25,facecolor='m',edgecolor='',zorder=2)
line62cen1,=ax2.plot(energy,r62cen,color='m',alpha=0.3,zorder=2)
#point62h=ax2.fill_between(energy,r62hdown,r62hup,color='r',alpha=0.25,facecolor='b',edgecolor='',zorder=1)
#line62h,=ax2.plot(energy,r62hcen,color='b',alpha=0.3,zorder=1)
exp=ax2.errorbar(energyrhic,value62,yerr=erro62,color='b',marker='*',linestyle='',linewidth=1,markersize=10,fillstyle='full',alpha=0.5,zorder=3)
#ax2.legend(((point62cen,band62cen,line62cen),exp),(r'fRG',r'STAR preliminary'),loc=0,fontsize='x-small',frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
ax3=fig.add_subplot(311)
errbartf421=ax3.errorbar(energy,r42cen,yerr=[r42errdown,r42errup],color='m',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
#ax3.errorbar(energy,r42hcen,yerr=[r42errhdown,r42errhup],color='b',marker='^',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=1)
#bandtf421=ax3.fill_between(energy,r42down,r42up,color='m',alpha=0.25,facecolor='m',edgecolor='',zorder=2)
linetf421,=ax3.plot(energy,r42cen,color='m',alpha=0.3,zorder=2)
#ax3.fill_between(energy,r42hdown,r42hup,color='b',alpha=0.25,facecolor='b',edgecolor='',zorder=1)
#ax3.plot(energy,r42hcen,color='b',alpha=0.3,zorder=1)
exp=ax3.errorbar(energy,kurtosis[:,0],yerr=kurtosis[:,1],color='c',marker='*',linestyle='',linewidth=1,markersize=10,fillstyle='full',alpha=0.5,zorder=3)
#ax3.errorbar(energy,kurtosis[:,0],color='red')
...
ax4=fig.add_subplot(313)
errbartf821=ax4.errorbar(energy,r82cen,yerr=[r82errdown,r82errup],color='m',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
ax4.errorbar(energy,r82cen,yerr=[r82errup,r82errdown],color='m',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
#ax4.errorbar(energy,r82hcen,yerr=[r82errhdown,r82errhup],color='b',marker='^',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=1)
#bandtf821=ax4.fill_between(energy,r82down,r82up,color='m',alpha=0.25,facecolor='m',edgecolor='',zorder=2)
linetf821,=ax4.plot(energy,r82cen,color='m',alpha=0.3,zorder=2)
#ax4.fill_between(energy,r82hdown,r82hup,color='b',alpha=0.25,facecolor='b',edgecolor='',zorder=1)
#ax4.plot(energy,r82hcen,color='b',alpha=0.3,zorder=1)
ax4.plot(blackline,r62line,dashes=[4,2],color='m',linewidth='1')
#ax4.legend([(errbartf,bandtf,linetf)],[r'fRG'],loc=0,fontsize='x-small',frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
#ax3.errorbar(energy,kurtosis[:,0],color='red')
ax3.plot(blackline,r42line,dashes=[4,2],color='m',linewidth='1')
ax3.legend([(errbartf422,bandtf422,linetf422),(errbartf423,linetf423),(errbartf421,linetf421),exp],[r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR I',r'fRG-LEFT freezeout: STAR II',r'STAR data'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
ax4.plot(blackline,r62line,dashes=[4,2],color='m',linewidth='1')
ax4.legend([(errbartf822,bandtf822,linetf822),(errbartf823,linetf823),(errbartf821,linetf821)],[r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR I',r'fRG-LEFT freezeout: STAR II'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
ax4.set_xscale('symlog')
ax4.set_yscale('symlog')
#plt.axis([5,230,-10000.,1000.])
