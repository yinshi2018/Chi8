...
plt.axes([0.6, 0.385, 0.25, 0.1])
point62cen3=plt.errorbar(energy,r62cen,yerr=[r62errdown,r62errup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
band62cen3=plt.fill_between(energy,r62down,r62up,color='blue',alpha=0.25,facecolor='r',edgecolor='',zorder=2)
line62cen3,=plt.plot(energy,r62cen,color='r',alpha=0.3,zorder=2)
plt.yscale('symlog')
plt.xscale('symlog')
...
plt.axes([0.6, 0.665, 0.25, 0.1])
errbartf423=plt.errorbar(energy,r42cen,yerr=[r42errdown,r42errup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
bandtf423=plt.fill_between(energy,r42down,r42up,color='r',alpha=0.25,facecolor='r',edgecolor='',zorder=2)
linetf423,=plt.plot(energy,r42cen,color='r',alpha=0.3,zorder=2)
plt.xscale('symlog')
plt.xticks(fontsize=6)
plt.yticks(fontsize=6)
plt.axis([5,230,-0.5,1.5])
...
plt.axes([0.6, 0.25, 0.25, 0.1])
errbartf823=plt.errorbar(energy,r82cen,yerr=[r82errdown,r82errup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
...
bandtf823=plt.fill_between(energy,r82down,r82up,color='r',alpha=0.25,facecolor='r',edgecolor='',zorder=2)
linetf823,=plt.plot(energy,r82cen,color='r',alpha=0.3,zorder=2)
plt.yscale('symlog')
plt.xscale('symlog')
plt.xticks(fontsize=6)
plt.yticks(fontsize=6)
...
band62cen1=ax2.fill_between(energy,r62down,r62up,color='blue',alpha=0.2,facecolor='b',edgecolor='',zorder=2)
...
bandtf421=ax3.fill_between(energy,r42down,r42up,color='b',alpha=0.2,facecolor='b',edgecolor='',zorder=2)
...
#ax4.errorbar(energy,r82hcen,yerr=[r82errhdown,r82errhup],color='b',marker='^',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=1)
bandtf821=ax4.fill_between(energy,r82down,r82up,color='b',alpha=0.2,facecolor='b',edgecolor='',zorder=2)
...
ax4.plot(blackline,r62line,dashes=[4,2],color='m',linewidth='1')
ax4.legend([(errbartf822,bandtf822,linetf822),(errbartf823,bandtf823,linetf823),(errbartf821,bandtf821,linetf821)],[r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR I',r'fRG-LEFT freezeout: STAR I'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
ax4.set_xscale('symlog')
ax4.set_yscale('symlog')
#plt.axis([5,230,-10000.,1000.])
plt.axis([5,230,-10000,10000])
