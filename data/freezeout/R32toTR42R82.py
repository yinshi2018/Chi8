...
point62cen=ax2.errorbar(energy,r62cen,yerr=[r62errdown,r62errup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7,zorder=2)
point62h=ax2.errorbar(energy,r62hcen,yerr=[r62errhdown,r62errhup],color='b',marker='^',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7,zorder=1)
...
exp=ax2.errorbar(energyrhic,value62,yerr=erro62,color='m',marker='*',linestyle='',linewidth=1,markersize=10,fillstyle='full',alpha=1,zorder=3)
...
ax3.errorbar(energy,r42cen,yerr=[r42errdown,r42errup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7,zorder=2)
ax3.errorbar(energy,r42hcen,yerr=[r42errhdown,r42errhup],color='b',marker='^',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7,zorder=1)
...
ax3.errorbar(energy,kurtosis[:,0],yerr=kurtosis[:,1],color='m',marker='*',linestyle='',linewidth=1,markersize=10,fillstyle='full',alpha=1,zorder=3)
...
errbartf=ax1.errorbar(energy,kurtosis[:,2],yerr=[r32errdown,r32errup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7,zorder=2)
errbartc=ax1.errorbar(energy,r32hcen,yerr=[r32errhdown,r32errhup],color='b',marker='^',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7,zorder=1)
...
exp=ax1.errorbar(energy,kurtosis[:,2],yerr=kurtosis[:,3],color='m',marker='*',linestyle='',linewidth=1,markersize=10,fillstyle='full',alpha=1,zorder=3)
...
ax4.errorbar(energy,r82cen,yerr=[r82errdown,r82errup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7,zorder=2)
ax4.errorbar(energy,r82hcen,yerr=[r82errhdown,r82errhup],color='b',marker='^',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7,zorder=1)
