...
point62cen=ax2.fill_between(energy,r62down,r62up,color='blue',alpha=0.4,facecolor='b',edgecolor='',zorder=1)
line62cen,=ax2.plot(energy,r62cen,alpha=0.75,zorder=1)
point62h=ax2.fill_between(energy,r62hdown,r62hup,color='r',alpha=0.4,facecolor='r',edgecolor='',zorder=1)
line62h,=ax2.plot(energy,r62hcen,color='r',alpha=0.75,zorder=1)
...
ax3.fill_between(energy,r42down,r42up,color='blue',alpha=0.4,facecolor='b',edgecolor='',zorder=1)
ax3.plot(energy,r42cen,color='blue',alpha=0.75,zorder=1)
ax3.fill_between(energy,r42hdown,r42hup,color='r',alpha=0.4,facecolor='r',edgecolor='',zorder=1)
ax3.plot(energy,r42hcen,color='r',alpha=0.75,zorder=1)
...
bandtf=ax1.fill_between(energy,r32down,r32up,color='blue',alpha=0.4,facecolor='b',edgecolor='',zorder=1)
linetf,=ax1.plot(energy,kurtosis[:,2],color='blue',alpha=0.75,zorder=1)
...
bandtc=ax1.fill_between(energy,r32hdown,r32hup,color='r',alpha=0.4,facecolor='r',edgecolor='',zorder=1)
linetc,=ax1.plot(energy,r32hcen,color='r',alpha=0.75,zorder=1)
ax1.legend(((bandtf,linetf),(bandtc,linetc),exp),(r'This work at $T_{CF}$',r'This work at $T_c$',r'RHIC data 0-5%'),loc=0,fontsize='x-small',frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
ax4.fill_between(energy,r82down,r82up,color='blue',alpha=0.4,facecolor='b',edgecolor='',zorder=1)
ax4.plot(energy,r82cen,color='blue',alpha=0.75,zorder=1)
ax4.fill_between(energy,r82hdown,r82hup,color='r',alpha=0.4,facecolor='r',edgecolor='',zorder=1)
ax4.plot(energy,r82hcen,color='r',alpha=0.75,zorder=1)
