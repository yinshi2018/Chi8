...
point62cen=ax2.errorbar(energy,r62cen,yerr=[r62errdown,r62errup],color='blue',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=1,zorder=0.7)
point62h=ax2.errorbar(energy,r62hcen,yerr=[r62errhdown,r62errhup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=1,zorder=0.7)
point62cen=ax2.fill_between(energy,r62down,r62up,color='blue',alpha=0.25,facecolor='b',edgecolor='',zorder=1)
line62cen,=ax2.plot(energy,r62cen,alpha=0.5,zorder=1)
point62h=ax2.fill_between(energy,r62hdown,r62hup,color='r',alpha=0.25,facecolor='r',edgecolor='',zorder=1)
line62h,=ax2.plot(energy,r62hcen,color='r',alpha=0.5,zorder=1)
exp=ax2.errorbar(energyrhic,value62,yerr=erro62,color='m',marker='s',linestyle='',linewidth=2,markersize=5,fillstyle='none',alpha=1,zorder=2)
...
ax3.errorbar(energy,r42cen,yerr=[r42errdown,r42errup],color='blue',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7)
ax3.errorbar(energy,r42hcen,yerr=[r42errhdown,r42errhup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7)
ax3.fill_between(energy,r42down,r42up,color='blue',alpha=0.25,facecolor='b',edgecolor='',zorder=1)
ax3.plot(energy,r42cen,color='blue',alpha=0.5,zorder=1)
ax3.fill_between(energy,r42hdown,r42hup,color='r',alpha=0.25,facecolor='r',edgecolor='',zorder=1)
ax3.plot(energy,r42hcen,color='r',alpha=0.5,zorder=1)
ax3.errorbar(energy,kurtosis[:,0],yerr=kurtosis[:,1],color='m',marker='s',linestyle='',linewidth=2,markersize=5,fillstyle='none',alpha=1,zorder=2)
...
errbartf=ax1.errorbar(energy,kurtosis[:,2],yerr=[r32errdown,r32errup],color='blue',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7)
errbartc=ax1.errorbar(energy,r32hcen,yerr=[r32errhdown,r32errhup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7)
bandtf=ax1.fill_between(energy,r32down,r32up,color='blue',alpha=0.25,facecolor='b',edgecolor='',zorder=1)
linetf,=ax1.plot(energy,kurtosis[:,2],color='blue',alpha=0.5,zorder=1)
exp=ax1.errorbar(energy,kurtosis[:,2],yerr=kurtosis[:,3],color='m',marker='s',linestyle='',linewidth=2,markersize=5,fillstyle='none',alpha=1,zorder=2)
bandtc=ax1.fill_between(energy,r32hdown,r32hup,color='r',alpha=0.25,facecolor='r',edgecolor='',zorder=1)
linetc,=ax1.plot(energy,r32hcen,color='r',alpha=0.5,zorder=1)
...
ax4.errorbar(energy,r82cen,yerr=[r82errdown,r82errup],color='blue',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7)
ax4.errorbar(energy,r82hcen,yerr=[r82errhdown,r82errhup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='none',alpha=0.7)
ax4.fill_between(energy,r82down,r82up,color='blue',alpha=0.25,facecolor='b',edgecolor='',zorder=1)
ax4.plot(energy,r82cen,color='blue',alpha=0.5,zorder=1)
ax4.fill_between(energy,r82hdown,r82hup,color='r',alpha=0.25,facecolor='r',edgecolor='',zorder=1)
ax4.plot(energy,r82hcen,color='r',alpha=0.5,zorder=1)
