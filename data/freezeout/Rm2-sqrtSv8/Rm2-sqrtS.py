...
ax2.legend(((point62cen2,band62cen2,line62cen2),(point62cen1,band62cen1,line62cen1),exp),(r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR',r'STAR preliminary'),loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
#ax3.errorbar(energy,kurtosis[:,0],color='red')
ax3.plot(blackline,r42line,dashes=[4,2],color='m',linewidth='1')
ax3.legend([(errbartf422,bandtf422,linetf422),(errbartf421,bandtf421,linetf421),exp],[r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR',r'STAR data'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
ax4.plot(blackline,r62line,dashes=[4,2],color='m',linewidth='1')
ax4.legend([(errbartf822,bandtf822,linetf822),(errbartf821,bandtf821,linetf821)],[r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
ax4.set_xscale('symlog')
ax4.set_yscale('symlog')
#plt.axis([5,230,-10000.,1000.])
