...
point62cen3=ax2.errorbar(energy,r62cen,yerr=[r62errdown,r62errup],color='g',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
...
errbartf423=ax3.errorbar(energy,r42cen,yerr=[r42errdown,r42errup],color='g',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,zorder=2)
...
ax4.plot(blackline,r62line,dashes=[4,2],color='m',linewidth='1')
ax4.legend([(errbartf822,bandtf822,linetf822),(errbartf823,bandtf823,linetf823),(errbartf821,bandtf821,linetf821)],[r'fRG-LEFT freezeout: Andronic et al.',r'fRG-LEFT freezeout: STAR I',r'fRG-LEFT freezeout: STAR II'],loc=0,fontsize=7,frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
ax4.set_xscale('symlog')
ax4.set_yscale('symlog')
#plt.axis([5,230,-10000.,1000.])
