...
chi1mub22cen=np.loadtxt(r'./mub22/cmucen/final/buffer/chi1.dat')
...
chi5mub22down=np.loadtxt(r'./mub22/cmudown/final/buffer/chi5.dat')
...
for t in range(0,20):
    if t<10:
       r5122[:,t]=spline(T/ct[t],r51mub22up,xsame)
    else:
       r5122[:,t]=spline(T/ct[t-10],r51mub22down,xsame)


for num in range(1,20):
    if num==1:
       max5122=np.maximum(r5122[:,num-1],r5122[:,num])
       min5122=np.minimum(r5122[:,num-1],r5122[:,num])
    else:
       max5122=np.maximum(max5122,r5122[:,num])
       min5122=np.minimum(min5122,r5122[:,num])
...
r51mub22cen=spline(T/ctcen,r51mub22cen,xsame)
...
r5122cen=r51mub22cen[min22cen_index]
...
r51=[max5122[min22up_index],max5122[min22down_index],min5122[min22up_index],min5122[min22down_index]]
r51h=[max5122[Tcup[0]],max5122[Tcdown[0]],min5122[Tcup[0]],min5122[Tcdown[0]]]
r5122up=np.max(r51)
r5122down=np.min(r51)
r5122uph=np.max(r51h)
r5122downh=np.min(r51h)
...
####################################################################################################
chi1mub68cen=np.loadtxt(r'./mub68/cmucen/final/buffer/chi1.dat')
...
chi5mub68cen=np.loadtxt(r'./mub68/cmucen/final/buffer/chi5.dat')
...
r51mub68cen=chi5mub68cen/chi1mub68cen
r52mub68cen=chi5mub68cen/chi2mub68cen
r62mub68cen=chi6mub68cen/chi2mub68cen
r82mub68cen=chi8mub68cen/chi2mub68cen
chi1mub68up=np.loadtxt(r'./mub68/cmuup/final/buffer/chi1.dat')
...
chi5mub68up=np.loadtxt(r'./mub68/cmuup/final/buffer/chi5.dat')
...
r51mub68up=chi5mub68up/chi1mub68up
r52mub68up=chi5mub68up/chi2mub68up
r62mub68up=chi6mub68up/chi2mub68up
r82mub68up=chi8mub68up/chi2mub68up
chi1mub68down=np.loadtxt(r'./mub68/cmudown/final/buffer/chi1.dat')
...
chi5mub68down=np.loadtxt(r'./mub68/cmudown/final/buffer/chi5.dat')
...
r51mub68down=chi5mub68down/chi1mub68down
r52mub68down=chi5mub68down/chi2mub68down
...
r5168=np.zeros((300,20))
r5268=np.zeros((300,20))
...
for t in range(0,20):
    if t<10:
       r5168[:,t]=spline(T/ct[t],r51mub68up,xsame)
    else:
       r5168[:,t]=spline(T/ct[t-10],r51mub68down,xsame)


for num in range(1,20):
    if num==1:
       max5168=np.maximum(r5168[:,num-1],r5168[:,num])
       min5168=np.minimum(r5168[:,num-1],r5168[:,num])
    else:
       max5168=np.maximum(max5168,r5168[:,num])
       min5168=np.minimum(min5168,r5168[:,num])

for t in range(0,20):
    if t<10:
       r5268[:,t]=spline(T/ct[t],r52mub68up,xsame)
    else:
       r5268[:,t]=spline(T/ct[t-10],r52mub68down,xsame)


for num in range(1,20):
    if num==1:
       max5268=np.maximum(r5268[:,num-1],r5268[:,num])
       min5268=np.minimum(r5268[:,num-1],r5268[:,num])
    else:
       max5268=np.maximum(max5268,r5268[:,num])
       min5268=np.minimum(min5268,r5268[:,num])
...
r51mub68cen=spline(T/ctcen,r51mub68cen,xsame)
...
r5168cen=r51mub68cen[min68cen_index]
...
r51=[max5168[min68up_index],max5168[min68down_index],min5168[min68up_index],min5168[min68down_index]]
#r42h=[max4268[min68up_index+int(min68up_index*deltat)],max4268[min68down_index+int(min68down_index*deltat)],min4268[min68up_index+int(min68up_index*deltat)],min4268[min68down_index+int(min68down_index*deltat)]]
r51h=[max5168[Tcup[1]],max5168[Tcdown[1]],min5168[Tcup[1]],min5168[Tcdown[1]]]
r5168up=np.max(r51)
r5168down=np.min(r51)
r5168uph=np.max(r51h)
r5168downh=np.min(r51h)
...
####################################################################################################
chi1mub78cen=np.loadtxt(r'./mub78/cmucen/final/buffer/chi1.dat')
...
chi5mub78cen=np.loadtxt(r'./mub78/cmucen/final/buffer/chi5.dat')
...
r51mub78cen=chi5mub78cen/chi1mub78cen
r52mub78cen=chi5mub78cen/chi2mub78cen
r62mub78cen=chi6mub78cen/chi2mub78cen
r82mub78cen=chi8mub78cen/chi2mub78cen
chi1mub78up=np.loadtxt(r'./mub78/cmuup/final/buffer/chi1.dat')
...
chi5mub78up=np.loadtxt(r'./mub78/cmuup/final/buffer/chi5.dat')
...
r51mub78up=chi5mub78up/chi1mub78up
r52mub78up=chi5mub78up/chi2mub78up
r62mub78up=chi6mub78up/chi2mub78up
r82mub78up=chi8mub78up/chi2mub78up
chi1mub78down=np.loadtxt(r'./mub78/cmudown/final/buffer/chi1.dat')
...
chi5mub78down=np.loadtxt(r'./mub78/cmudown/final/buffer/chi5.dat')
...
r51mub78down=chi5mub78down/chi1mub78down
r52mub78down=chi5mub78down/chi2mub78down
...
r5178=np.zeros((300,20))
r5278=np.zeros((300,20))
...
for t in range(0,20):
    if t<10:
       r5178[:,t]=spline(T/ct[t],r51mub78up,xsame)
    else:
       r5178[:,t]=spline(T/ct[t-10],r51mub78down,xsame)


for num in range(1,20):
    if num==1:
       max5178=np.maximum(r5178[:,num-1],r5178[:,num])
       min5178=np.minimum(r5178[:,num-1],r5178[:,num])
    else:
       max5178=np.maximum(max5178,r5178[:,num])
       min5178=np.minimum(min5178,r5178[:,num])


for t in range(0,20):
    if t<10:
       r5278[:,t]=spline(T/ct[t],r52mub78up,xsame)
    else:
       r5278[:,t]=spline(T/ct[t-10],r52mub78down,xsame)


for num in range(1,20):
    if num==1:
       max5278=np.maximum(r5278[:,num-1],r5278[:,num])
       min5278=np.minimum(r5278[:,num-1],r5278[:,num])
    else:
       max5278=np.maximum(max5278,r5278[:,num])
       min5278=np.minimum(min5278,r5278[:,num])
...
r51mub78cen=spline(T/ctcen,r51mub78cen,xsame)
r52mub78cen=spline(T/ctcen,r52mub78cen,xsame)
...
r5178cen=r51mub78cen[min78cen_index]
...
r51=[max5178[min78up_index],max5178[min78down_index],min5178[min78up_index],min5178[min78down_index]]
#r42h=[max4278[min78up_index+int(min78up_index*deltat)],max4278[min78down_index+int(min78down_index*deltat)],min4278[min78up_index+int(min78up_index*deltat)],min4278[min78down_index+int(min78down_index*deltat)]]
r51h=[max5178[Tcup[2]],max5178[Tcdown[2]],min5178[Tcup[2]],min5178[Tcdown[2]]]
r5178up=np.max(r51)
r5178down=np.min(r51)
r5178uph=np.max(r51h)
r5178downh=np.min(r51h)
...
####################################################################################################
chi1mub106cen=np.loadtxt(r'./mub106/cmucen/final/buffer/chi1.dat')
...
chi5mub106cen=np.loadtxt(r'./mub106/cmucen/final/buffer/chi5.dat')
...
r51mub106cen=chi5mub106cen/chi1mub106cen
r52mub106cen=chi5mub106cen/chi2mub106cen
r62mub106cen=chi6mub106cen/chi2mub106cen
r82mub106cen=chi8mub106cen/chi2mub106cen
chi1mub106up=np.loadtxt(r'./mub106/cmuup/final/buffer/chi1.dat')
...
chi5mub106up=np.loadtxt(r'./mub106/cmuup/final/buffer/chi5.dat')
...
r51mub106up=chi5mub106up/chi1mub106up
r52mub106up=chi5mub106up/chi2mub106up
r62mub106up=chi6mub106up/chi2mub106up
r82mub106up=chi8mub106up/chi2mub106up
chi1mub106down=np.loadtxt(r'./mub106/cmudown/final/buffer/chi1.dat')
...
chi5mub106down=np.loadtxt(r'./mub106/cmudown/final/buffer/chi5.dat')
...
r51mub106down=chi5mub106down/chi1mub106down
r52mub106down=chi5mub106down/chi2mub106down
...
r51106=np.zeros((300,20))
r52106=np.zeros((300,20))
...
for t in range(0,20):
    if t<10:
       r51106[:,t]=spline(T/ct[t],r51mub106up,xsame)
    else:
       r51106[:,t]=spline(T/ct[t-10],r51mub106down,xsame)


for num in range(1,20):
    if num==1:
       max51106=np.maximum(r51106[:,num-1],r51106[:,num])
       min51106=np.minimum(r51106[:,num-1],r51106[:,num])
    else:
       max51106=np.maximum(max51106,r51106[:,num])
       min51106=np.minimum(min51106,r51106[:,num])

for t in range(0,20):
    if t<10:
       r52106[:,t]=spline(T/ct[t],r52mub106up,xsame)
    else:
       r52106[:,t]=spline(T/ct[t-10],r52mub106down,xsame)


for num in range(1,20):
    if num==1:
       max52106=np.maximum(r52106[:,num-1],r52106[:,num])
       min52106=np.minimum(r52106[:,num-1],r52106[:,num])
    else:
       max52106=np.maximum(max52106,r52106[:,num])
       min52106=np.minimum(min52106,r52106[:,num])
...
r51mub106cen=spline(T/ctcen,r51mub106cen,xsame)
r52mub106cen=spline(T/ctcen,r52mub106cen,xsame)
...
r51106cen=r51mub106cen[min106cen_index]
...
r51106hcen=r51mub106cen[Tcen[3]]
...
r51=[max51106[min106up_index],max51106[min106down_index],min51106[min106up_index],min51106[min106down_index]]
#r42h=[max42106[min106up_index+int(min106up_index*deltat)],max42106[min106down_index+int(min106down_index*deltat)],min42106[min106up_index+int(min106up_index*deltat)],min42106[min106down_index+int(min106down_index*deltat)]]
r51h=[max51106[Tcup[3]],max51106[Tcdown[3]],min51106[Tcup[3]],min51106[Tcdown[3]]]
r51106up=np.max(r51)
r51106down=np.min(r51)
r51106uph=np.max(r51h)
r51106downh=np.min(r51h)
...
####################################################################################################
chi1mub148cen=np.loadtxt(r'./mub148/cmucen/final/buffer/chi1.dat')
...
chi5mub148cen=np.loadtxt(r'./mub148/cmucen/final/buffer/chi5.dat')
...
r51mub148cen=chi5mub148cen/chi1mub148cen
r52mub148cen=chi5mub148cen/chi2mub148cen
r62mub148cen=chi6mub148cen/chi2mub148cen
r82mub148cen=chi8mub148cen/chi2mub148cen
chi1mub148up=np.loadtxt(r'./mub148/cmuup/final/buffer/chi1.dat')
...
chi5mub148up=np.loadtxt(r'./mub148/cmuup/final/buffer/chi5.dat')
...
r51mub148up=chi5mub148up/chi1mub148up
r52mub148up=chi5mub148up/chi2mub148up
r62mub148up=chi6mub148up/chi2mub148up
r82mub148up=chi8mub148up/chi2mub148up
chi1mub148down=np.loadtxt(r'./mub148/cmudown/final/buffer/chi1.dat')
...
chi5mub148down=np.loadtxt(r'./mub148/cmudown/final/buffer/chi5.dat')
...
r51mub148down=chi5mub148down/chi1mub148down
r52mub148down=chi5mub148down/chi2mub148down
...
r51148=np.zeros((300,20))
r52148=np.zeros((300,20))
...
for t in range(0,20):
    if t<10:
       r51148[:,t]=spline(T/ct[t],r51mub148up,xsame)
    else:
       r51148[:,t]=spline(T/ct[t-10],r51mub148down,xsame)


for num in range(1,20):
    if num==1:
       max51148=np.maximum(r51148[:,num-1],r51148[:,num])
       min51148=np.minimum(r51148[:,num-1],r51148[:,num])
    else:
       max51148=np.maximum(max51148,r51148[:,num])
       min51148=np.minimum(min51148,r51148[:,num])

for t in range(0,20):
    if t<10:
       r52148[:,t]=spline(T/ct[t],r52mub148up,xsame)
    else:
       r52148[:,t]=spline(T/ct[t-10],r52mub148down,xsame)


for num in range(1,20):
    if num==1:
       max52148=np.maximum(r52148[:,num-1],r52148[:,num])
       min52148=np.minimum(r52148[:,num-1],r52148[:,num])
    else:
       max52148=np.maximum(max52148,r52148[:,num])
       min52148=np.minimum(min52148,r52148[:,num])
...
r51mub148cen=spline(T/ctcen,r51mub148cen,xsame)
r52mub148cen=spline(T/ctcen,r52mub148cen,xsame)
...
r51148cen=r51mub148cen[min148cen_index]
...
r51148hcen=r51mub148cen[Tcen[4]]
...
r51=[max51148[min148up_index],max51148[min148down_index],min51148[min148up_index],min51148[min148down_index]]
#r42h=[max42148[min148up_index+int(min148up_index*deltat)],max42148[min148down_index+int(min148down_index*deltat)],min42148[min148up_index+int(min148up_index*deltat)],min42148[min148down_index+int(min148down_index*deltat)]]
r51h=[max51148[Tcup[4]],max51148[Tcdown[4]],min51148[Tcup[4]],min51148[Tcdown[4]]]
r51148up=np.max(r51)
r51148down=np.min(r51)
r51148uph=np.max(r51h)
r51148downh=np.min(r51h)
...
####################################################################################################
chi1mub196cen=np.loadtxt(r'./mub196/cmucen/final/buffer/chi1.dat')
...
chi5mub196cen=np.loadtxt(r'./mub196/cmucen/final/buffer/chi5.dat')
...
r51mub196cen=chi5mub196cen/chi1mub196cen
r52mub196cen=chi5mub196cen/chi2mub196cen
r62mub196cen=chi6mub196cen/chi2mub196cen
r82mub196cen=chi8mub196cen/chi2mub196cen
chi1mub196up=np.loadtxt(r'./mub196/cmuup/final/buffer/chi1.dat')
...
chi5mub196up=np.loadtxt(r'./mub196/cmuup/final/buffer/chi5.dat')
...
r51mub196up=chi5mub196up/chi1mub196up
r52mub196up=chi5mub196up/chi2mub196up
r62mub196up=chi6mub196up/chi2mub196up
r82mub196up=chi8mub196up/chi2mub196up
chi1mub196up1=np.loadtxt(r'./mub196/cmuup1/final/buffer/chi1.dat')
...
chi5mub196up1=np.loadtxt(r'./mub196/cmuup1/final/buffer/chi5.dat')
...
r51mub196up1=chi5mub196up1/chi1mub196up1
r52mub196up1=chi5mub196up1/chi2mub196up1
r62mub196up1=chi6mub196up1/chi2mub196up1
r82mub196up1=chi8mub196up1/chi2mub196up1
chi1mub196up2=np.loadtxt(r'./mub196/cmuup2/final/buffer/chi1.dat')
...
chi5mub196up2=np.loadtxt(r'./mub196/cmuup2/final/buffer/chi5.dat')
...
r51mub196up2=chi5mub196up2/chi1mub196up2
r52mub196up2=chi5mub196up2/chi2mub196up2
r62mub196up2=chi6mub196up2/chi2mub196up2
r82mub196up2=chi8mub196up2/chi2mub196up2
chi1mub196up3=np.loadtxt(r'./mub196/cmuup3/final/buffer/chi1.dat')
...
chi5mub196up3=np.loadtxt(r'./mub196/cmuup3/final/buffer/chi5.dat')
...
r51mub196up3=chi5mub196up3/chi1mub196up3
r52mub196up3=chi5mub196up3/chi2mub196up3
r62mub196up3=chi6mub196up3/chi2mub196up3
r82mub196up3=chi8mub196up3/chi2mub196up3
chi1mub196up4=np.loadtxt(r'./mub196/cmuup4/final/buffer/chi1.dat')
...
chi5mub196up4=np.loadtxt(r'./mub196/cmuup4/final/buffer/chi5.dat')
...
r51mub196up4=chi5mub196up4/chi1mub196up4
r52mub196up4=chi5mub196up4/chi2mub196up4
r62mub196up4=chi6mub196up4/chi2mub196up4
r82mub196up4=chi8mub196up4/chi2mub196up4
chi1mub196down=np.loadtxt(r'./mub196/cmudown/final/buffer/chi1.dat')
...
chi5mub196down=np.loadtxt(r'./mub196/cmudown/final/buffer/chi5.dat')
...
r51mub196down=chi5mub196down/chi1mub196down
r52mub196down=chi5mub196down/chi2mub196down
r62mub196down=chi6mub196down/chi2mub196down
r82mub196down=chi8mub196down/chi2mub196down
chi1mub196down1=np.loadtxt(r'./mub196/cmudown1/final/buffer/chi1.dat')
...
chi5mub196down1=np.loadtxt(r'./mub196/cmudown1/final/buffer/chi5.dat')
...
r51mub196down1=chi5mub196down1/chi1mub196down1
r52mub196down1=chi5mub196down1/chi2mub196down1
r62mub196down1=chi6mub196down1/chi2mub196down1
r82mub196down1=chi8mub196down1/chi2mub196down1
chi1mub196down2=np.loadtxt(r'./mub196/cmudown2/final/buffer/chi1.dat')
...
chi5mub196down2=np.loadtxt(r'./mub196/cmudown2/final/buffer/chi5.dat')
...
r51mub196down2=chi5mub196down2/chi1mub196down2
r52mub196down2=chi5mub196down2/chi2mub196down2
r62mub196down2=chi6mub196down2/chi2mub196down2
r82mub196down2=chi8mub196down2/chi2mub196down2
chi1mub196down3=np.loadtxt(r'./mub196/cmudown3/final/buffer/chi1.dat')
...
chi5mub196down3=np.loadtxt(r'./mub196/cmudown3/final/buffer/chi5.dat')
...
r51mub196down3=chi5mub196down3/chi1mub196down3
r52mub196down3=chi5mub196down3/chi2mub196down3
r62mub196down3=chi6mub196down3/chi2mub196down3
r82mub196down3=chi8mub196down3/chi2mub196down3
chi1mub196down4=np.loadtxt(r'./mub196/cmudown4/final/buffer/chi1.dat')
...
chi5mub196down4=np.loadtxt(r'./mub196/cmudown4/final/buffer/chi5.dat')
...
r51mub196down4=chi5mub196down4/chi1mub196down4
r52mub196down4=chi5mub196down4/chi2mub196down4
...
r51196=np.zeros((300,100))
r52196=np.zeros((300,100))
...
for t in range(0,100):
    if t<10:
       r51196[:,t]=spline(T/ct[t],r51mub196up,xsame)
    else:
       if t>=10 and t<20:
          r51196[:,t]=spline(T/ct[t-10],r51mub196up1,xsame)
       else:
          if t>=20 and t<30:
             r51196[:,t]=spline(T/ct[t-20],r51mub196up2,xsame)
          else: 
             if t>=30 and t<40:
                r51196[:,t]=spline(T/ct[t-30],r51mub196up3,xsame)
             else: 
                if t>=40 and t<50:
                   r51196[:,t]=spline(T/ct[t-40],r51mub196up4,xsame)
                else:
                   if t>=50 and t<60:
                      r51196[:,t]=spline(T/ct[t-50],r51mub196down,xsame)
                   else: 
                      if t>=60 and t<70:
                         r51196[:,t]=spline(T/ct[t-60],r51mub196down1,xsame)
                      else:
                         if t>=70 and t<80:
                            r51196[:,t]=spline(T/ct[t-70],r51mub196down2,xsame)
                         else: 
                            if t>=80 and t<90:
                               r51196[:,t]=spline(T/ct[t-80],r51mub196down3,xsame)
                            else:
                                r51196[:,t]=spline(T/ct[t-90],r51mub196down4,xsame)


for t in range(0,100):
    if t<10:
       r52196[:,t]=spline(T/ct[t],r52mub196up,xsame)
    else:
       if t>=10 and t<20:
          r52196[:,t]=spline(T/ct[t-10],r52mub196up1,xsame)
       else:
          if t>=20 and t<30:
             r52196[:,t]=spline(T/ct[t-20],r52mub196up2,xsame)
          else: 
             if t>=30 and t<40:
                r52196[:,t]=spline(T/ct[t-30],r52mub196up3,xsame)
             else: 
                if t>=40 and t<50:
                   r52196[:,t]=spline(T/ct[t-40],r52mub196up4,xsame)
                else:
                   if t>=50 and t<60:
                      r52196[:,t]=spline(T/ct[t-50],r52mub196down,xsame)
                   else: 
                      if t>=60 and t<70:
                         r52196[:,t]=spline(T/ct[t-60],r52mub196down1,xsame)
                      else:
                         if t>=70 and t<80:
                            r52196[:,t]=spline(T/ct[t-70],r52mub196down2,xsame)
                         else: 
                            if t>=80 and t<90:
                               r52196[:,t]=spline(T/ct[t-80],r52mub196down3,xsame)
                            else:
                                r52196[:,t]=spline(T/ct[t-90],r52mub196down4,xsame)
...
for num in range(1,100):
    if num==1:
       max51196=np.maximum(r51196[:,num-1],r51196[:,num])
       min51196=np.minimum(r51196[:,num-1],r51196[:,num])
    else:
       max51196=np.maximum(max51196,r51196[:,num])
       min51196=np.minimum(min51196,r51196[:,num])

for num in range(1,100):
    if num==1:
       max52196=np.maximum(r52196[:,num-1],r52196[:,num])
       min52196=np.minimum(r52196[:,num-1],r52196[:,num])
    else:
       max52196=np.maximum(max52196,r52196[:,num])
       min52196=np.minimum(min52196,r52196[:,num])
...
r51mub196cen=spline(T/ctcen,r51mub196cen,xsame)
r52mub196cen=spline(T/ctcen,r52mub196cen,xsame)
...
r51196cen=r51mub196cen[min196cen_index]
...
r51196hcen=r51mub196cen[Tcen[5]]
...
r51=[max51196[min196up_index],max51196[min196down_index],min51196[min196up_index],min51196[min196down_index]]
#r42h=[max42196[min196up_index+int(min196up_index*deltat)],max42196[min196down_index+int(min196down_index*deltat)],min42196[min196up_index+int(min196up_index*deltat)],min42196[min196down_index+int(min196down_index*deltat)]]
r51h=[max51196[Tcup[5]],max51196[Tcdown[5]],min51196[Tcup[5]],min51196[Tcdown[5]]]
r51196up=np.max(r51)
r51196down=np.min(r51)
r51196uph=np.max(r51h)
r51196downh=np.min(r51h)
...
####################################################################################################
chi1mub252cen=np.loadtxt(r'./mub252/cmucen/final/buffer/chi1.dat')
...
chi5mub252cen=np.loadtxt(r'./mub252/cmucen/final/buffer/chi5.dat')
...
r51mub252cen=chi5mub252cen/chi1mub252cen
r52mub252cen=chi5mub252cen/chi2mub252cen
r62mub252cen=chi6mub252cen/chi2mub252cen
r82mub252cen=chi8mub252cen/chi2mub252cen
chi1mub252up=np.loadtxt(r'./mub252/cmuup/final/buffer/chi1.dat')
...
chi5mub252up=np.loadtxt(r'./mub252/cmuup/final/buffer/chi5.dat')
...
r51mub252up=chi5mub252up/chi1mub252up
r52mub252up=chi5mub252up/chi2mub252up
r62mub252up=chi6mub252up/chi2mub252up
r82mub252up=chi8mub252up/chi2mub252up
chi1mub252up1=np.loadtxt(r'./mub252/cmuup1/final/buffer/chi1.dat')
...
chi5mub252up1=np.loadtxt(r'./mub252/cmuup1/final/buffer/chi5.dat')
...
r51mub252up1=chi5mub252up1/chi1mub252up1
r52mub252up1=chi5mub252up1/chi2mub252up1
r62mub252up1=chi6mub252up1/chi2mub252up1
r82mub252up1=chi8mub252up1/chi2mub252up1
chi1mub252up2=np.loadtxt(r'./mub252/cmuup2/final/buffer/chi1.dat')
...
chi5mub252up2=np.loadtxt(r'./mub252/cmuup2/final/buffer/chi5.dat')
...
r51mub252up2=chi5mub252up2/chi1mub252up2
r52mub252up2=chi5mub252up2/chi2mub252up2
r62mub252up2=chi6mub252up2/chi2mub252up2
r82mub252up2=chi8mub252up2/chi2mub252up2
chi1mub252up3=np.loadtxt(r'./mub252/cmuup3/final/buffer/chi1.dat')
...
chi5mub252up3=np.loadtxt(r'./mub252/cmuup3/final/buffer/chi5.dat')
...
r51mub252up3=chi5mub252up3/chi1mub252up3
r52mub252up3=chi5mub252up3/chi2mub252up3
r62mub252up3=chi6mub252up3/chi2mub252up3
r82mub252up3=chi8mub252up3/chi2mub252up3
chi1mub252up4=np.loadtxt(r'./mub252/cmuup4/final/buffer/chi1.dat')
...
chi5mub252up4=np.loadtxt(r'./mub252/cmuup4/final/buffer/chi5.dat')
...
r51mub252up4=chi5mub252up4/chi1mub252up4
r52mub252up4=chi5mub252up4/chi2mub252up4
r62mub252up4=chi6mub252up4/chi2mub252up4
r82mub252up4=chi8mub252up4/chi2mub252up4
chi1mub252down=np.loadtxt(r'./mub252/cmudown/final/buffer/chi1.dat')
...
chi5mub252down=np.loadtxt(r'./mub252/cmudown/final/buffer/chi5.dat')
...
r51mub252down=chi5mub252down/chi1mub252down
r52mub252down=chi5mub252down/chi2mub252down
r62mub252down=chi6mub252down/chi2mub252down
r82mub252down=chi8mub252down/chi2mub252down
chi1mub252down1=np.loadtxt(r'./mub252/cmudown1/final/buffer/chi1.dat')
...
chi5mub252down1=np.loadtxt(r'./mub252/cmudown1/final/buffer/chi5.dat')
...
r51mub252down1=chi5mub252down1/chi1mub252down1
r52mub252down1=chi5mub252down1/chi2mub252down1
r62mub252down1=chi6mub252down1/chi2mub252down1
r82mub252down1=chi8mub252down1/chi2mub252down1
chi1mub252down2=np.loadtxt(r'./mub252/cmudown2/final/buffer/chi1.dat')
...
chi5mub252down2=np.loadtxt(r'./mub252/cmudown2/final/buffer/chi5.dat')
...
r51mub252down2=chi5mub252down2/chi1mub252down2
r52mub252down2=chi5mub252down2/chi2mub252down2
r62mub252down2=chi6mub252down2/chi2mub252down2
r82mub252down2=chi8mub252down2/chi2mub252down2
chi1mub252down3=np.loadtxt(r'./mub252/cmudown3/final/buffer/chi1.dat')
...
chi5mub252down3=np.loadtxt(r'./mub252/cmudown3/final/buffer/chi5.dat')
...
r51mub252down3=chi5mub252down3/chi1mub252down3
r52mub252down3=chi5mub252down3/chi2mub252down3
r62mub252down3=chi6mub252down3/chi2mub252down3
r82mub252down3=chi8mub252down3/chi2mub252down3
chi1mub252down4=np.loadtxt(r'./mub252/cmudown4/final/buffer/chi1.dat')
...
chi5mub252down4=np.loadtxt(r'./mub252/cmudown4/final/buffer/chi5.dat')
...
r51mub252down4=chi5mub252down4/chi1mub252down4
r52mub252down4=chi5mub252down4/chi2mub252down4
...
r51252=np.zeros((300,100))
r52252=np.zeros((300,100))
...
for t in range(0,100):
    if t<10:
       r51252[:,t]=spline(T/ct[t],r51mub252up,xsame)
    else:
       if t>=10 and t<20:
          r51252[:,t]=spline(T/ct[t-10],r51mub252up1,xsame)
       else:
          if t>=20 and t<30:
             r51252[:,t]=spline(T/ct[t-20],r51mub252up2,xsame)
          else: 
             if t>=30 and t<40:
                r51252[:,t]=spline(T/ct[t-30],r51mub252up3,xsame)
             else: 
                if t>=40 and t<50:
                   r51252[:,t]=spline(T/ct[t-40],r51mub252up4,xsame)
                else:
                   if t>=50 and t<60:
                      r51252[:,t]=spline(T/ct[t-50],r51mub252down,xsame)
                   else: 
                      if t>=60 and t<70:
                         r51252[:,t]=spline(T/ct[t-60],r51mub252down1,xsame)
                      else:
                         if t>=70 and t<80:
                            r51252[:,t]=spline(T/ct[t-70],r51mub252down2,xsame)
                         else: 
                            if t>=80 and t<90:
                               r51252[:,t]=spline(T/ct[t-80],r51mub252down3,xsame)
                            else:
                                r51252[:,t]=spline(T/ct[t-90],r51mub252down4,xsame)


for t in range(0,100):
    if t<10:
       r52252[:,t]=spline(T/ct[t],r52mub252up,xsame)
    else:
       if t>=10 and t<20:
          r52252[:,t]=spline(T/ct[t-10],r52mub252up1,xsame)
       else:
          if t>=20 and t<30:
             r52252[:,t]=spline(T/ct[t-20],r52mub252up2,xsame)
          else: 
             if t>=30 and t<40:
                r52252[:,t]=spline(T/ct[t-30],r52mub252up3,xsame)
             else: 
                if t>=40 and t<50:
                   r52252[:,t]=spline(T/ct[t-40],r52mub252up4,xsame)
                else:
                   if t>=50 and t<60:
                      r52252[:,t]=spline(T/ct[t-50],r52mub252down,xsame)
                   else: 
                      if t>=60 and t<70:
                         r52252[:,t]=spline(T/ct[t-60],r52mub252down1,xsame)
                      else:
                         if t>=70 and t<80:
                            r52252[:,t]=spline(T/ct[t-70],r52mub252down2,xsame)
                         else: 
                            if t>=80 and t<90:
                               r52252[:,t]=spline(T/ct[t-80],r52mub252down3,xsame)
                            else:
                                r52252[:,t]=spline(T/ct[t-90],r52mub252down4,xsame)
...
for num in range(1,100):
    if num==1:
       max51252=np.maximum(r51252[:,num-1],r51252[:,num])
       min51252=np.minimum(r51252[:,num-1],r51252[:,num])
    else:
       max51252=np.maximum(max51252,r51252[:,num])
       min51252=np.minimum(min51252,r51252[:,num])


for num in range(1,100):
    if num==1:
       max52252=np.maximum(r52252[:,num-1],r52252[:,num])
       min52252=np.minimum(r52252[:,num-1],r52252[:,num])
    else:
       max52252=np.maximum(max52252,r52252[:,num])
       min52252=np.minimum(min52252,r52252[:,num])
...
r51mub252cen=spline(T/ctcen,r51mub252cen,xsame)
r52mub252cen=spline(T/ctcen,r52mub252cen,xsame)
...
r51252cen=r51mub252cen[min252cen_index]
...
r51252hcen=r51mub252cen[Tcen[6]]
...
r51=[max51252[min252up_index],max51252[min252down_index],min51252[min252up_index],min51252[min252down_index]]
#r42h=[max42252[min252up_index+int(min252up_index*deltat)],max42252[min252down_index+int(min252down_index*deltat)],min42252[min252up_index+int(min252up_index*deltat)],min42252[min252down_index+int(min252down_index*deltat)]]
r51h=[max51252[Tcup[6]],max51252[Tcdown[6]],min51252[Tcup[6]],min51252[Tcdown[6]]]
r51252up=np.max(r51)
r51252down=np.min(r51)
r51252uph=np.max(r51h)
r51252downh=np.min(r51h)
...
#####################################################################################################
chi1mub303cen=np.loadtxt(r'./mub303/cmucen/final/buffer/chi1.dat')
...
chi5mub303cen=np.loadtxt(r'./mub303/cmucen/final/buffer/chi5.dat')
...
r51mub303cen=chi5mub303cen/chi1mub303cen
r52mub303cen=chi5mub303cen/chi2mub303cen
r62mub303cen=chi6mub303cen/chi2mub303cen
r82mub303cen=chi8mub303cen/chi2mub303cen
chi1mub303up=np.loadtxt(r'./mub303/cmuup/final/buffer/chi1.dat')
...
chi5mub303up=np.loadtxt(r'./mub303/cmuup/final/buffer/chi5.dat')
...
r51mub303up=chi5mub303up/chi1mub303up
r52mub303up=chi5mub303up/chi2mub303up
r62mub303up=chi6mub303up/chi2mub303up
r82mub303up=chi8mub303up/chi2mub303up
chi1mub303up1=np.loadtxt(r'./mub303/cmuup1/final/buffer/chi1.dat')
...
chi5mub303up1=np.loadtxt(r'./mub303/cmuup1/final/buffer/chi5.dat')
...
r51mub303up1=chi5mub303up1/chi1mub303up1
r52mub303up1=chi5mub303up1/chi2mub303up1
r62mub303up1=chi6mub303up1/chi2mub303up1
r82mub303up1=chi8mub303up1/chi2mub303up1
chi1mub303up2=np.loadtxt(r'./mub303/cmuup2/final/buffer/chi1.dat')
...
chi5mub303up2=np.loadtxt(r'./mub303/cmuup2/final/buffer/chi5.dat')
...
r51mub303up2=chi5mub303up2/chi1mub303up2
r52mub303up2=chi5mub303up2/chi2mub303up2
r62mub303up2=chi6mub303up2/chi2mub303up2
r82mub303up2=chi8mub303up2/chi2mub303up2
chi1mub303up3=np.loadtxt(r'./mub303/cmuup3/final/buffer/chi1.dat')
...
chi5mub303up3=np.loadtxt(r'./mub303/cmuup3/final/buffer/chi5.dat')
...
r51mub303up3=chi5mub303up3/chi1mub303up3
r52mub303up3=chi5mub303up3/chi2mub303up3
r62mub303up3=chi6mub303up3/chi2mub303up3
r82mub303up3=chi8mub303up3/chi2mub303up3
chi1mub303up4=np.loadtxt(r'./mub303/cmuup4/final/buffer/chi1.dat')
...
chi5mub303up4=np.loadtxt(r'./mub303/cmuup4/final/buffer/chi5.dat')
...
r51mub303up4=chi5mub303up4/chi1mub303up4
r52mub303up4=chi5mub303up4/chi2mub303up4
r62mub303up4=chi6mub303up4/chi2mub303up4
r82mub303up4=chi8mub303up4/chi2mub303up4
chi1mub303down=np.loadtxt(r'./mub303/cmudown/final/buffer/chi1.dat')
...
chi5mub303down=np.loadtxt(r'./mub303/cmudown/final/buffer/chi5.dat')
...
r51mub303down=chi5mub303down/chi1mub303down
r52mub303down=chi5mub303down/chi2mub303down
r62mub303down=chi6mub303down/chi2mub303down
r82mub303down=chi8mub303down/chi2mub303down
chi1mub303down1=np.loadtxt(r'./mub303/cmudown1/final/buffer/chi1.dat')
...
chi5mub303down1=np.loadtxt(r'./mub303/cmudown1/final/buffer/chi5.dat')
...
r51mub303down1=chi5mub303down1/chi1mub303down1
r52mub303down1=chi5mub303down1/chi2mub303down1
r62mub303down1=chi6mub303down1/chi2mub303down1
r82mub303down1=chi8mub303down1/chi2mub303down1
chi1mub303down2=np.loadtxt(r'./mub303/cmudown2/final/buffer/chi1.dat')
...
chi5mub303down2=np.loadtxt(r'./mub303/cmudown2/final/buffer/chi5.dat')
...
r51mub303down2=chi5mub303down2/chi1mub303down2
r52mub303down2=chi5mub303down2/chi2mub303down2
r62mub303down2=chi6mub303down2/chi2mub303down2
r82mub303down2=chi8mub303down2/chi2mub303down2
chi1mub303down3=np.loadtxt(r'./mub303/cmudown3/final/buffer/chi1.dat')
...
chi5mub303down3=np.loadtxt(r'./mub303/cmudown3/final/buffer/chi5.dat')
...
r51mub303down3=chi5mub303down3/chi1mub303down3
r52mub303down3=chi5mub303down3/chi2mub303down3
r62mub303down3=chi6mub303down3/chi2mub303down3
r82mub303down3=chi8mub303down3/chi2mub303down3
chi1mub303down4=np.loadtxt(r'./mub303/cmudown4/final/buffer/chi1.dat')
...
chi5mub303down4=np.loadtxt(r'./mub303/cmudown4/final/buffer/chi5.dat')
...
r51mub303down4=chi5mub303down4/chi1mub303down4
r52mub303down4=chi5mub303down4/chi2mub303down4
...
r51303=np.zeros((300,100))
r52303=np.zeros((300,100))
...
for t in range(0,100):
    if t<10:
       r51303[:,t]=spline(T/ct[t],r51mub303up,xsame)
    else:
       if t>=10 and t<20:
          r51303[:,t]=spline(T/ct[t-10],r51mub303up1,xsame)
       else:
          if t>=20 and t<30:
             r51303[:,t]=spline(T/ct[t-20],r51mub303up2,xsame)
          else: 
             if t>=30 and t<40:
                r51303[:,t]=spline(T/ct[t-30],r51mub303up3,xsame)
             else: 
                if t>=40 and t<50:
                   r51303[:,t]=spline(T/ct[t-40],r51mub303up4,xsame)
                else:
                   if t>=50 and t<60:
                      r51303[:,t]=spline(T/ct[t-50],r51mub303down,xsame)
                   else: 
                      if t>=60 and t<70:
                         r51303[:,t]=spline(T/ct[t-60],r51mub303down1,xsame)
                      else:
                         if t>=70 and t<80:
                            r51303[:,t]=spline(T/ct[t-70],r51mub303down2,xsame)
                         else: 
                            if t>=80 and t<90:
                               r51303[:,t]=spline(T/ct[t-80],r51mub303down3,xsame)
                            else:
                                r51303[:,t]=spline(T/ct[t-90],r51mub303down4,xsame)



for t in range(0,100):
    if t<10:
       r52303[:,t]=spline(T/ct[t],r52mub303up,xsame)
    else:
       if t>=10 and t<20:
          r52303[:,t]=spline(T/ct[t-10],r52mub303up1,xsame)
       else:
          if t>=20 and t<30:
             r52303[:,t]=spline(T/ct[t-20],r52mub303up2,xsame)
          else: 
             if t>=30 and t<40:
                r52303[:,t]=spline(T/ct[t-30],r52mub303up3,xsame)
             else: 
                if t>=40 and t<50:
                   r52303[:,t]=spline(T/ct[t-40],r52mub303up4,xsame)
                else:
                   if t>=50 and t<60:
                      r52303[:,t]=spline(T/ct[t-50],r52mub303down,xsame)
                   else: 
                      if t>=60 and t<70:
                         r52303[:,t]=spline(T/ct[t-60],r52mub303down1,xsame)
                      else:
                         if t>=70 and t<80:
                            r52303[:,t]=spline(T/ct[t-70],r52mub303down2,xsame)
                         else: 
                            if t>=80 and t<90:
                               r52303[:,t]=spline(T/ct[t-80],r52mub303down3,xsame)
                            else:
                                r52303[:,t]=spline(T/ct[t-90],r52mub303down4,xsame)
...
for num in range(1,100):
    if num==1:
       max51303=np.maximum(r51303[:,num-1],r51303[:,num])
       min51303=np.minimum(r51303[:,num-1],r51303[:,num])
    else:
       max51303=np.maximum(max51303,r51303[:,num])
       min51303=np.minimum(min51303,r51303[:,num])

for num in range(1,100):
    if num==1:
       max52303=np.maximum(r52303[:,num-1],r52303[:,num])
       min52303=np.minimum(r52303[:,num-1],r52303[:,num])
    else:
       max52303=np.maximum(max52303,r52303[:,num])
       min52303=np.minimum(min52303,r52303[:,num])
...
r51mub303cen=spline(T/ctcen,r51mub303cen,xsame)
r52mub303cen=spline(T/ctcen,r52mub303cen,xsame)
...
r51303cen=r51mub303cen[min303cen_index]
...
r51303hcen=r51mub303cen[Tcen[7]]
...
r51=[max51303[min303up_index],max51303[min303down_index],min51303[min303up_index],min51303[min303down_index]]
#r51h=[max42303[min303up_index+int(min303up_index*deltat)],max42303[min303down_index+int(min303down_index*deltat)],min42303[min303up_index+int(min303up_index*deltat)],min42303[min303down_index+int(min303down_index*deltat)]]
r51h=[max51303[Tcup[7]],max51303[Tcdown[7]],min51303[Tcup[7]],min51303[Tcdown[7]]]
r51303up=np.max(r51)
r51303down=np.min(r51)
r51303uph=np.max(r51h)
r51303downh=np.min(r51h)
...
####################################################################################################
chi1mub406cen=np.loadtxt(r'./mub406/cmucen/final/buffer/chi1.dat')
...
chi5mub406cen=np.loadtxt(r'./mub406/cmucen/final/buffer/chi5.dat')
...
r51mub406cen=chi5mub406cen/chi1mub406cen
r52mub406cen=chi5mub406cen/chi2mub406cen
r62mub406cen=chi6mub406cen/chi2mub406cen
r82mub406cen=chi8mub406cen/chi2mub406cen
chi1mub406up=np.loadtxt(r'./mub406/cmuup/final/buffer/chi1.dat')
...
chi5mub406up=np.loadtxt(r'./mub406/cmuup/final/buffer/chi5.dat')
...
r51mub406up=chi5mub406up/chi1mub406up
r52mub406up=chi5mub406up/chi2mub406up
r62mub406up=chi6mub406up/chi2mub406up
r82mub406up=chi8mub406up/chi2mub406up
chi1mub406up1=np.loadtxt(r'./mub406/cmuup1/final/buffer/chi1.dat')
...
chi5mub406up1=np.loadtxt(r'./mub406/cmuup1/final/buffer/chi5.dat')
...
r51mub406up1=chi5mub406up1/chi1mub406up1
r52mub406up1=chi5mub406up1/chi2mub406up1
r62mub406up1=chi6mub406up1/chi2mub406up1
r82mub406up1=chi8mub406up1/chi2mub406up1
chi1mub406up2=np.loadtxt(r'./mub406/cmuup2/final/buffer/chi1.dat')
...
chi5mub406up2=np.loadtxt(r'./mub406/cmuup2/final/buffer/chi5.dat')
...
r51mub406up2=chi5mub406up2/chi1mub406up2
r52mub406up2=chi5mub406up2/chi2mub406up2
r62mub406up2=chi6mub406up2/chi2mub406up2
r82mub406up2=chi8mub406up2/chi2mub406up2
chi1mub406up3=np.loadtxt(r'./mub406/cmuup3/final/buffer/chi1.dat')
...
chi5mub406up3=np.loadtxt(r'./mub406/cmuup3/final/buffer/chi5.dat')
...
r51mub406up3=chi5mub406up3/chi1mub406up3
r52mub406up3=chi5mub406up3/chi2mub406up3
r62mub406up3=chi6mub406up3/chi2mub406up3
r82mub406up3=chi8mub406up3/chi2mub406up3
chi1mub406up4=np.loadtxt(r'./mub406/cmuup4/final/buffer/chi1.dat')
...
chi5mub406up4=np.loadtxt(r'./mub406/cmuup4/final/buffer/chi5.dat')
...
r51mub406up4=chi5mub406up4/chi1mub406up4
r52mub406up4=chi5mub406up4/chi2mub406up4
r62mub406up4=chi6mub406up4/chi2mub406up4
r82mub406up4=chi8mub406up4/chi2mub406up4
chi1mub406down=np.loadtxt(r'./mub406/cmudown/final/buffer/chi1.dat')
...
chi5mub406down=np.loadtxt(r'./mub406/cmudown/final/buffer/chi5.dat')
...
r51mub406down=chi5mub406down/chi1mub406down
r52mub406down=chi5mub406down/chi2mub406down
r62mub406down=chi6mub406down/chi2mub406down
r82mub406down=chi8mub406down/chi2mub406down
chi1mub406down1=np.loadtxt(r'./mub406/cmudown1/final/buffer/chi1.dat')
...
chi5mub406down1=np.loadtxt(r'./mub406/cmudown1/final/buffer/chi5.dat')
...
r51mub406down1=chi5mub406down1/chi1mub406down1
r52mub406down1=chi5mub406down1/chi2mub406down1
r62mub406down1=chi6mub406down1/chi2mub406down1
r82mub406down1=chi8mub406down1/chi2mub406down1
chi1mub406down2=np.loadtxt(r'./mub406/cmudown2/final/buffer/chi1.dat')
...
chi5mub406down2=np.loadtxt(r'./mub406/cmudown2/final/buffer/chi5.dat')
...
r51mub406down2=chi5mub406down2/chi1mub406down2
r52mub406down2=chi5mub406down2/chi2mub406down2
r62mub406down2=chi6mub406down2/chi2mub406down2
r82mub406down2=chi8mub406down2/chi2mub406down2
chi1mub406down3=np.loadtxt(r'./mub406/cmudown3/final/buffer/chi1.dat')
...
chi5mub406down3=np.loadtxt(r'./mub406/cmudown3/final/buffer/chi5.dat')
...
r51mub406down3=chi5mub406down3/chi1mub406down3
r52mub406down3=chi5mub406down3/chi2mub406down3
r62mub406down3=chi6mub406down3/chi2mub406down3
r82mub406down3=chi8mub406down3/chi2mub406down3
chi1mub406down4=np.loadtxt(r'./mub406/cmudown4/final/buffer/chi1.dat')
...
chi5mub406down4=np.loadtxt(r'./mub406/cmudown4/final/buffer/chi5.dat')
...
r51mub406down4=chi5mub406down4/chi1mub406down4
r52mub406down4=chi5mub406down4/chi2mub406down4
...
r51406=np.zeros((300,100))
r52406=np.zeros((300,100))
...
for t in range(0,100):
    if t<10:
       r51406[:,t]=spline(T/ct[t],r51mub406up,xsame)
    else:
       if t>=10 and t<20:
          r51406[:,t]=spline(T/ct[t-10],r51mub406up1,xsame)
       else:
          if t>=20 and t<30:
             r51406[:,t]=spline(T/ct[t-20],r51mub406up2,xsame)
          else: 
             if t>=30 and t<40:
                r51406[:,t]=spline(T/ct[t-30],r51mub406up3,xsame)
             else: 
                if t>=40 and t<50:
                   r51406[:,t]=spline(T/ct[t-40],r51mub406up4,xsame)
                else:
                   if t>=50 and t<60:
                      r51406[:,t]=spline(T/ct[t-50],r51mub406down,xsame)
                   else: 
                      if t>=60 and t<70:
                         r51406[:,t]=spline(T/ct[t-60],r51mub406down1,xsame)
                      else:
                         if t>=70 and t<80:
                            r51406[:,t]=spline(T/ct[t-70],r51mub406down2,xsame)
                         else: 
                            if t>=80 and t<90:
                               r51406[:,t]=spline(T/ct[t-80],r51mub406down3,xsame)
                            else:
                                r51406[:,t]=spline(T/ct[t-90],r51mub406down4,xsame)

for t in range(0,100):
    if t<10:
       r52406[:,t]=spline(T/ct[t],r52mub406up,xsame)
    else:
       if t>=10 and t<20:
          r52406[:,t]=spline(T/ct[t-10],r52mub406up1,xsame)
       else:
          if t>=20 and t<30:
             r52406[:,t]=spline(T/ct[t-20],r52mub406up2,xsame)
          else: 
             if t>=30 and t<40:
                r52406[:,t]=spline(T/ct[t-30],r52mub406up3,xsame)
             else: 
                if t>=40 and t<50:
                   r52406[:,t]=spline(T/ct[t-40],r52mub406up4,xsame)
                else:
                   if t>=50 and t<60:
                      r52406[:,t]=spline(T/ct[t-50],r52mub406down,xsame)
                   else: 
                      if t>=60 and t<70:
                         r52406[:,t]=spline(T/ct[t-60],r52mub406down1,xsame)
                      else:
                         if t>=70 and t<80:
                            r52406[:,t]=spline(T/ct[t-70],r52mub406down2,xsame)
                         else: 
                            if t>=80 and t<90:
                               r52406[:,t]=spline(T/ct[t-80],r52mub406down3,xsame)
                            else:
                                r52406[:,t]=spline(T/ct[t-90],r52mub406down4,xsame)
...
for num in range(1,100):
    if num==1:
       max51406=np.maximum(r51406[:,num-1],r51406[:,num])
       min51406=np.minimum(r51406[:,num-1],r51406[:,num])
    else:
       max51406=np.maximum(max51406,r51406[:,num])
       min51406=np.minimum(min51406,r51406[:,num])

for num in range(1,100):
    if num==1:
       max52406=np.maximum(r52406[:,num-1],r52406[:,num])
       min52406=np.minimum(r52406[:,num-1],r52406[:,num])
    else:
       max52406=np.maximum(max52406,r52406[:,num])
       min52406=np.minimum(min52406,r52406[:,num])
...
r52mub406cen=spline(T/ctcen,r52mub406cen,xsame)
...
r51406cen=r51mub406cen[min406cen_index]
...
r51406hcen=r51mub406cen[Tcen[8]]
...
r51=[max51406[min406up_index],max51406[min406down_index],min51406[min406up_index],min51406[min406down_index]]
#r51h=[max42406[min406up_index+int(min406up_index*deltat)],max42406[min406down_index+int(min406down_index*deltat)],min42406[min406up_index+int(min406up_index*deltat)],min42406[min406down_index+int(min406down_index*deltat)]]
r51h=[max51406[Tcup[8]],max51406[Tcdown[8]],min51406[Tcup[8]],min51406[Tcdown[8]]]
r51406up=np.max(r51)
r51406down=np.min(r51)
r51406uph=np.max(r51h)
r51406downh=np.min(r51h)
...
r51up=[r5122up,r5168up,r5178up,r51106up,r51148up,r51196up,r51252up,r51303up,r51406up]
r51down=[r5122down,r5168down,r5178down,r51106down,r51148down,r51196down,r51252down,r51303down,r51406down]
r51cen=[r5122cen,r5168cen,r5178cen,r51106cen,r51148cen,r51196cen,r51252cen,r51303cen,r51406cen]
...
for i in range(0,9):
    ...
    r51errup[i]=r51up[i]-r51cen[i]
    r51errdown[i]=r51cen[i]-r51down[i]
...
errbartf423=ax3.errorbar(energy,r51cen,yerr=[r51errdown,r51errup],color='r',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.5,capsize=1,elinewidth=4,zorder=2)
bandtf423=ax3.fill_between(energy,r51down,r51up,color='r',alpha=0.2,facecolor='r',edgecolor='',zorder=2)
linetf423,=ax3.plot(energy,r51cen,color='r',alpha=0.3,zorder=2)
