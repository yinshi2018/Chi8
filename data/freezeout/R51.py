...
errbartf423=ax3.errorbar(energy,r51cen,yerr=[r51errdown,r51errup],color='g',marker='o',linestyle='',linewidth=1,markersize=5,fillstyle='full',alpha=0.3,capsize=1,elinewidth=4,zorder=2)
bandtf423=ax3.fill_between(energy,r51down,r51up,color='g',alpha=0.2,facecolor='g',edgecolor='',zorder=2)
