...
paraline,=ax1.plot(muB,T,dashes=[4,2],color='b',linewidth=1.5,alpha=0.5,label=r'Parameterization')
star7,=ax1.plot(muBstar,sevenpointstar,color='r',linewidth=1.5,alpha=0.5,label=r'freezeout: STAR I')
star4,=ax1.plot(muBstar,fourpointstar,dashes=[1,0.5],color='g',linewidth=1.5,alpha=0.5,label=r'freezeout: STAR II')
...
paraline,=plt.plot(muB,T,dashes=[4,2],color='b',linewidth=1.5,alpha=0.5,label=r'Parameterization')
star7,=plt.plot(muBstar,sevenpointstar,color='r',linewidth=1.5,alpha=0.5,label=r'freezeout: STAR I')
star4,=plt.plot(muBstar,fourpointstar,dashes=[1,0.5],color='g',linewidth=1.5,alpha=0.5,label=r'freezeout: STAR II')
