...
star7,=ax1.plot(muBstar,sevenpointstar,color='g',alpha=0.5,label=r'freezeout: STAR I')
star4,=ax1.plot(muBstar,fourpointstar,dashes=[1,0.5],color='m',alpha=0.5,label=r'freezeout: STAR II')
...
star7,=plt.plot(muBstar,sevenpointstar,color='g',alpha=0.5,label=r'freezeout: STAR I')
star4,=plt.plot(muBstar,fourpointstar,dashes=[1,0.5],color='m',alpha=0.5,label=r'freezeout: STAR II')
