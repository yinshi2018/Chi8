...
ax1.plot(mubfrg*cmu/(200.0*ct),R62200,'-',color='b',linewidth=1,alpha=0.5)
...
ax1.plot(mubfrg*cmu/(195.0*ct),R62195,'-',color='k',linewidth=1,alpha=0.5)#,label=r'This work T=155 MeV')
...
ax1.fill_between(mub/160.,R62[:,60]-errR622[:,60],R62[:,60]+errR622[:,60],alpha=0.25,facecolor='darkgreen',edgecolor='',label=r'HotQCD T=160 MeV')
ax1.fill_between(mub/155.,R62[:,50]-errR622[:,50],R62[:,50]+errR622[:,50],alpha=0.25,facecolor='lime',edgecolor='',label=r'HotQCD T=155 MeV')
ax1.fill_between(mub/160.,WBR62[:,5]-WBerrR622[:,5],WBR62[:,5]+WBerrR622[:,5],alpha=0.25,facecolor='brown',edgecolor='',label=r'WB T=160 MeV')

ax1.fill_between(mub/155.,WBR62[:,4]-WBerrR622[:,4],WBR62[:,4]+WBerrR622[:,4],alpha=0.25,facecolor='r',edgecolor='',label=r'WB T=155 MeV')
