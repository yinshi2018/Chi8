...
ax1.fill_betweenx(r42,Tfrg/ct1,Tfrg/ct2,alpha=0.25,facecolor='r',edgecolor='r',label=r'$c_T=1.247(12)$')
#ax1.axvspan(Tfrg/ct1,Tfrg/ct2 , r42, alpha=0.5, color='red')
ax1.plot(Tfrg/ct,r42,'-',color='r',linewidth=1,alpha=0.5)#,label=r'ct between 1.24 and 1.26')
...
ax1.fill_between(T,R42[0,:]+errR422[0,:],R42[0,:]-errR422[0,:],alpha=0.25,facecolor='green',edgecolor='',label=r'HotQCD 2001.08530')
...
ax1.errorbar(WBR42[:,0],WBR42[:,1],yerr=WBR42[:,2],color='blue',marker='o',linestyle='',linewidth=2,markersize=5,fillstyle='none',alpha=1,label=r'WB 1805.04445')
