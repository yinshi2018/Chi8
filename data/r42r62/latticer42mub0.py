...
ax1.fill_betweenx(r42,Tfrg/ct1,Tfrg/ct2,alpha=0.25,facecolor='r',edgecolor='r',label=r'$c_T=1.24-1.26$')
#ax1.axvspan(Tfrg/ct1,Tfrg/ct2 , r42, alpha=0.5, color='red')
#ax1.plot(Tfrg/ct,r42,'-',color='k',linewidth=1,label=r'ct between 1.24 and 1.26')
...
ax1.fill_between(hotQCDR42[:,0],hotQCDR42[:,1]+hotQCDR42[:,2],hotQCDR42[:,1]-hotQCDR42[:,2],alpha=0.25,facecolor='b',edgecolor='',label=r'HotQCD 1708.04897')

ax1.plot(T,c4/c2,'g-',linewidth=1,markersize=5,alpha=0.5)#,label=r'$mid$')
ax1.fill_between(T,R42[0,:]+errR42[0,:],R42[0,:]-errR42[0,:],alpha=0.25,facecolor='green',edgecolor='',label=r'HotQCD 2001.08530')
...
ax1.errorbar(WBR42[:,0],WBR42[:,1],yerr=WBR42[:,2],color='blue',marker='o',linestyle='',linewidth=2,markersize=5,fillstyle='none',alpha=1,label=r'W-B 1805.04445')
...
ax2.plot(Tfrg/ct,r62,'-',color='k',linewidth=1)#,label=r'$T=194\,\mathrm{MeV}$')
#ax1.plot(mubfrg/199.0,R42199,'-',color='r',linewidth=1,label=r'$T=199\,\mathrm{MeV}$')
#ax1.plot(mubfrg/189.0,R42189,'-',color='g',linewidth=1,label=r'$T=189\,\mathrm{MeV}$')
...
ax2.fill_between(T,R62[0,:]+errR62[0,:],R62[0,:]-errR62[0,:],alpha=0.25,facecolor='green',edgecolor='')#,label=r'HotQCD cont. est')
#ax1.errorbar(mub/158.,R42[:,56],yerr=errR422[:,56],color='blue',marker='o',linestyle='',linewidth=2,markersize=2,fillstyle='none',alpha=1,label=r'HotQCD')
#ax2.fill_between(hotQCDR62[:,0]/156,hotQCDR62[:,1],hotQCDR62[:,2],alpha=0.25,facecolor='green',edgecolor='',label=r'HotQCD cont. est')
...
ax3.plot(Tfrg/ct,r82,'-',color='k',linewidth=1)#,label=r'$T=194\,\mathrm{MeV}$')
#ax1.plot(mubfrg/199.0,R42199,'-',color='r',linewidth=1,label=r'$T=199\,\mathrm{MeV}$')
#ax1.plot(mubfrg/189.0,R42189,'-',color='g',linewidth=1,label=r'$T=189\,\mathrm{MeV}$')
...
#plt.scatter(207./194., -0.4)
#ax1.plot(T/155.,c4/c2,'k-',linewidth=2,markersize=5,label=r'$T$')
ax3.fill_between(T,R82[0,:]+errR82[0,:],R82[0,:]-errR82[0,:],alpha=0.25,facecolor='green',edgecolor='')#,label=r'HotQCD cont. est')
#ax1.errorbar(mub/158.,R42[:,56],yerr=errR422[:,56],color='blue',marker='o',linestyle='',linewidth=2,markersize=2,fillstyle='none',alpha=1,label=r'HotQCD')
#ax2.fill_between(hotQCDR62[:,0]/156,hotQCDR62[:,1],hotQCDR62[:,2],alpha=0.25,facecolor='green',edgecolor='',label=r'HotQCD cont. est')
...
plt.plot(Tfrg/ct,r82,'-',color='k',linewidth=1)#,label=r'$T=194\,\mathrm{MeV}$')
...
fig.subplots_adjust(top=0.9, bottom=0.17, left=0.06, right=0.96, hspace=0.35,
                    wspace=0.24)

fig.savefig("mub0erro.pdf")
