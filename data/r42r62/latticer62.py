...
WBc2=np.loadtxt('../data1/WB_chi2.dat')
WBc4=np.loadtxt('../data1/WB_chi4.dat')
WBc6=np.loadtxt('../data1/WB_chi6.dat')
WBc8=np.loadtxt('../data1/WB_chi8.dat')
WBerrc2=np.zeros((18))
WBerrc4=np.loadtxt('../data1/WB_chi4erro.dat')
WBerrc6=np.loadtxt('../data1/WB_chi6erro.dat')
WBerrc8=np.loadtxt('../data1/WB_chi8erro.dat')
...
#ax1.plot(mubfrg/194.0,R62194,'-',color='k',linewidth=1,label=r'$T=194\,\mathrm{MeV}$')
#ax1.plot(mubfrg/199.0,R62199,'-',color='r',linewidth=1,label=r'$T=199\,\mathrm{MeV}$')
#ax1.plot(mubfrg/198.0,R62198,'-',color='g',linewidth=1,label=r'$T=198\,\mathrm{MeV}$')
#ax1.plot(mubfrg/197.0,R62197,'-',color='y',linewidth=1,label=r'$T=197\,\mathrm{MeV}$')
#ax1.plot(mubfrg/196.0,R62196,'-',color='m',linewidth=1,label=r'$T=196\,\mathrm{MeV}$')
#ax1.plot(mubfrg/195.0,R62195,'-',color='b',linewidth=1,label=r'$T=195\,\mathrm{MeV}$')

ax1.plot(mubfrg*cmu/(200.0*ct),R62200,'-',color='b',linewidth=1,label=r'This work T=160 MeV')
ax1.plot(mubfrg*cmu/(194.0*ct),R62194,'-',color='k',linewidth=1,label=r'This work T=155 MeV')
...
ax1.fill_between(mub/160.,R62[:,60]-errR62[:,60],R62[:,60]+errR62[:,60],alpha=0.25,facecolor='red',edgecolor='',label=r'HotQCD T=160 MeV')
ax1.fill_between(mub/155.,R62[:,50]-errR62[:,50],R62[:,50]+errR62[:,50],alpha=0.25,facecolor='m',edgecolor='',label=r'HotQCD T=155 MeV')
ax1.fill_between(mub/155.,WBR62[:,4]-WBerrR62[:,4],WBR62[:,4]+WBerrR62[:,4],alpha=0.25,facecolor='k',edgecolor='',label=r'W-B T=155 MeV')

ax1.fill_between(mub/160.,WBR62[:,5]-WBerrR62[:,5],WBR62[:,5]+WBerrR62[:,5],alpha=0.25,facecolor='g',edgecolor='',label=r'W-B T=160 MeV')
ax1.axis([0,0.8,-3,1.])
