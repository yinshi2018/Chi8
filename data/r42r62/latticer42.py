...
for num1 in range(0,101):
    for num2 in range(0,101):
        ...
        errR422[num1,num2]=abs(chi4[num1,num2]/(chi2[num1,num2]**2))*errc2[num2]+abs(1./chi2[num1,num2]-chi4[num1,num2]/(chi2[num1,num2])**2*1./(2.*1.)*(4.*num1/T[num2])**2)*errc4[num2]+abs(1./chi2[num1,num2]*1./(2.*1.)*(4.*num1/T[num2])**2)*errc6[num2]
...
ax1.plot(mubfrg*cmu/(200.0*ct),R42200,'-',color='b',linewidth=1,label=r'This work T=160 MeV')

ax1.plot(mubfrg*cmu/(194.0*ct),R42194,'-',color='k',linewidth=1,label=r'This work T=155 MeV')
...
ax1.fill_between(mub/160.,r42160up,r42160down,alpha=0.25,facecolor='r',edgecolor='',label=r'HotQCD T=160 MeV')
ax1.fill_between(mub/155.,R42[:,50]-errR422[:,50],R42[:,50]+errR422[:,50],alpha=0.25,facecolor='m',edgecolor='',label=r'HotQCD T=155 MeV')
ax1.fill_between(mub/160.,WBR42[:,5]-WBerrR42[:,5],WBR42[:,5]+WBerrR42[:,5],alpha=0.25,facecolor='g',edgecolor='',label=r'W-B T=160 MeV')
ax1.fill_between(mub/155.,WBR42[:,4]-WBerrR42[:,4],WBR42[:,4]+WBerrR42[:,4],alpha=0.25,facecolor='k',edgecolor='',label=r'W-B T=155 MeV')
