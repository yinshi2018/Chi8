...
ax1.legend(((band_FRG,line_FRG),(band_HotQCD,line_HotQCD),band_HotQCD17,points_WB),(r'This work',r'HotQCD (2020)',r'HotQCD (2017)',r'WB'),loc=0,fontsize='x-small',frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
