...
line_Nf2,=ax2.plot(pb_Nf2[:,0]/cmu,Tc_Nf2/ct,'--',color='fuchsia',linewidth=1.5,markersize=5,zorder=2,label=r'$N_f=2$')
CEP_Nf2,=ax2.plot(muB_CEP_Nf2/cmu,T_CEP_Nf2/ct,'*',color='fuchsia',markersize=8,zorder=2,label=r'CEP: $N_f=2$')
band_Nf2=ax2.fill_between(pb_Nf2[:,0]/cmu,pb_Nf2[:,1]/ct,pb_Nf2[:,2]/ct,color='gray',alpha=.2,zorder=2,label=r'$N_f=2$')


line_Nf2p1,=ax2.plot(pb_Nf2p1[:,0],Tc_Nf2p1,'k--',dashes=(5,2),linewidth=1.5,markersize=5,zorder=1,label=r'$N_f=2+1$')
CEP_Nf2p1,=ax2.plot(muB_CEP_Nf2p1,T_CEP_Nf2p1,'ko',markersize=8,zorder=1,label=r'CEP: $N_f=2+1$')
band_Nf2p1=ax2.fill_between(pb_Nf2p1[:,0],pb_Nf2p1[:,1],pb_Nf2p1[:,2],color='blue',alpha=0.2,label=r'$N_f=2+1$')

ax2.fill_between(muB5,muB5/4.,0,alpha=0.35,facecolor='gray',edgecolor='',zorder=3)

ax2.plot(muB,muB/2.,'k:',linewidth=1.,markersize=5)
ax2.plot(muB,muB/3.,'k:',linewidth=1.,markersize=5)
ax2.plot(muB4,muB4/4.,'r',dashes=(5,2),linewidth=2.,markersize=5,zorder=4)
