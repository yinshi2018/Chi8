...
line_FRG_T160,=ax1.plot(mubfrg*cmu/(200.0*ct),R42200,'--',dashes=(1,2),color='k',linewidth=1.5,alpha=0.75,zorder=2)
xsame=np.linspace(0.,1.2,100)
power1=spline(x1,R42198,xsame)
power2=spline(x2,R42201,xsame)
band_FRG_T160=ax1.fill_between(xsame,power1,power2,alpha=0.4,facecolor='m',edgecolor='',zorder=1,label=r'This work T=160 MeV')
x3=mubfrg*cmu2/(193.0*ct1)
x4=mubfrg*cmu1/(196.0*ct2)
line_FRG_T155,=ax1.plot(mubfrg*cmu/(195.0*ct),R42195,'--',dashes=(5,2),color='k',linewidth=1.5,alpha=0.75,zorder=2)
xsame2=np.linspace(0.,1.2,100)
power3=spline(x3,R42193,xsame2)
power4=spline(x4,R42196,xsame2)
band_FRG_T155=ax1.fill_between(xsame2,power3,power4,alpha=0.4,facecolor='r',edgecolor='',zorder=1,label=r'This work T=155 MeV')
...
bandexp_FRG_T160=ax1.fill_between(xsame,powerup160,powerdown160,alpha=0.4,facecolor='c',edgecolor='',zorder=1,label=r'Expansion T=160 MeV')
...
bandexp_FRG_T155=ax1.fill_between(xsame,powerup155,powerdown155,alpha=0.4,facecolor='b',edgecolor='',zorder=1,label=r'Expansion T=155 MeV')
exp_FRG_T155,=ax1.plot(mub*cmu/(195*ct),chi4f[194,:]/chi2f[194,:],'--',dashes=(5,2),color='b',linewidth=1.5,zorder=2,alpha=0.75)
exp_FRG_T160,=ax1.plot(mub*cmu/(200*ct),chi4f[199,:]/chi2f[199,:],'--',dashes=(1,2),color='b',linewidth=1.5,zorder=2,alpha=0.75)
...
ax1.legend(((band_FRG_T155,line_FRG_T155),(band_FRG_T160,line_FRG_T160),(bandexp_FRG_T155,exp_FRG_T155),(bandexp_FRG_T160,exp_FRG_T160)),(r'Calculation result $T=155$ MeV',r'Calculation result $T=160$ MeV',r'Expansion result $T=155$ MeV',r'Expansion result $T=160$ MeV'),loc=0,fontsize='x-small',frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1)
...
x1=mubfrg*cmu2/(198.0*ct1)
x2=mubfrg*cmu1/(201.0*ct2)
line_FRG_T160,=ax2.plot(mubfrg*cmu/(200.0*ct),R62200,'--',dashes=(1,2),color='k',linewidth=1.5,alpha=0.75,zorder=2)
xsame=np.linspace(0.,1.2,100)
power1=spline(x1,R62198,xsame)
power2=spline(x2,R62201,xsame)
band_FRG_T160=ax2.fill_between(xsame,power1,power2,alpha=0.4,facecolor='m',edgecolor='',zorder=1,label=r'This work T=160 MeV')
x3=mubfrg*cmu2/(193.0*ct1)
x4=mubfrg*cmu1/(196.0*ct2)
line_FRG_T155,=ax2.plot(mubfrg*cmu/(195.0*ct),R62195,'--',dashes=(5,2),color='k',linewidth=1.5,alpha=0.75,zorder=2)
xsame2=np.linspace(0.,1.2,100)
power3=spline(x3,R62193,xsame2)
power4=spline(x4,R62196,xsame2)
band_FRG_T155=ax2.fill_between(xsame2,power3,power4,alpha=0.4,facecolor='r',edgecolor='',zorder=1,label=r'This work T=155 MeV')
xup160=mub*cmu2/(198.*ct1)
xdown160=mub*cmu1/(201.*ct2)
xsame=np.linspace(0.,1.2,100)
powerup160=spline(xup160,chi6f[197,:]/chi2f[197,:],xsame)
powerdown160=spline(xdown160,chi6f[200,:]/chi2f[200,:],xsame)
bandexp_FRG_T160=ax2.fill_between(xsame,powerup160,powerdown160,alpha=0.4,facecolor='c',edgecolor='',zorder=1,label=r'Expansion T=160 MeV')
xup155=mub*cmu2/(193.*ct1)
xdown155=mub*cmu1/(196.*ct2)
xsame=np.linspace(0.,1.2,100)
powerup155=spline(xup155,chi6f[192,:]/chi2f[192,:],xsame)
powerdown155=spline(xdown155,chi6f[195,:]/chi2f[195,:],xsame)
bandexp_FRG_T155=ax2.fill_between(xsame,powerup155,powerdown155,alpha=0.4,facecolor='b',edgecolor='',zorder=1,label=r'Expansion T=155 MeV')
exp_FRG_T155,=ax2.plot(mub*cmu/(195*ct),chi6f[194,:]/chi2f[194,:],'--',dashes=(5,2),color='b',linewidth=1.5,alpha=0.75,zorder=2)
exp_FRG_T160,=ax2.plot(mub*cmu/(200*ct),chi6f[199,:]/chi2f[199,:],'--',dashes=(1,2),color='b',linewidth=1.5,alpha=0.75,zorder=2)
