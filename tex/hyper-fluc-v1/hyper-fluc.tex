...
\caption{$R^{B}_{32}$ (left top), $R^{B}_{42}$ (left bottom), $R^{B}_{62}$ (right top), and $R^{B}_{82}$ (right bottom) as functions of the collision energy, calculated in LEFT within the fRG approach on the freeze-out line and the pseudocritical line, respectively. Experimental data from the STAR collaboration are also shown for comparison, where $R^{p}_{32}$ (left top) and $R^{p}_{42}$ (left bottom) are the skewness and kurtosis of the net-proton distributions measured in Au+Au central (0-5\%) collisions \cite{Adam:2020unf}, and $R^{p}_{62}$ (right top) is the preliminary result on the six-order cumulant of the net-proton distribution at $\sqrt{s_{NN}}$=200 GeV and 54.4 GeV with centrality 0-40\% \cite{Nonaka:2020crv,Pandav:2020uzx}.}\label{fig:Rm2-sqrtS}
\end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
