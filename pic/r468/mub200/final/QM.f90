...
!order of chebyshev polynomial
  real(8) dcd0mu(mmax),dcd1mu(mmax),dcd2mu(mmax),dcd3mu(mmax),dcd4mu(mmax),dcd5mu(mmax)
  real(8) factorial,dcd6mu(mmax),dcd7mu(mmax),dcd8mu(mmax),chi(mmax,0:iTmax)
  real(8) fpi_res(0:jmumax,0:iTmax),mPion_res(0:jmumax,0:iTmax),mSigma_res(0:jmumax,0:iTmax)
  integer iT,iv
  real(8) l_i,lb_i,l_i_mu,lb_i_mu,mf_res(0:jmumax,0:iTmax)
